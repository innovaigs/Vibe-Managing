# Workflow: Optimize Governance

## Founder intents
"Improve our governance outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize decision rights, board effectiveness, policies, accountability, and stakeholder oversight, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `board-operating-cadence`, `decision-rights-design`, `policy-management`, `stakeholder-accountability` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track decision-right clarity, policy compliance, board action closure and guardrail metrics at the appropriate cadence.
