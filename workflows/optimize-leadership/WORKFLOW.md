# Workflow: Optimize Leadership

## Founder intents
"Improve our leadership outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize decision quality, change, succession, executive leverage, and organizational clarity, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `executive-decision-system`, `change-management`, `succession-planning` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track decision cycle time, change adoption, leadership bench strength and guardrail metrics at the appropriate cadence.
