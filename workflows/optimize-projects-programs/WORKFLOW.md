# Workflow: Optimize Projects & Programs

## Founder intents
"Improve our projects & programs outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize initiative delivery, dependencies, benefits, resources, and portfolio governance, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `project-charter`, `schedule-and-dependency-risk`, `program-governance`, `benefits-realization` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track benefits realized, schedule predictability, portfolio throughput and guardrail metrics at the appropriate cadence.
