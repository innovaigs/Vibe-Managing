# Workflow: Optimize Marketing

## Founder intents
"Improve our marketing outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize market creation, brand, demand, lifecycle communication, and channel economics, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `brand-strategy`, `lifecycle-marketing`, `marketing-mix-model` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track incremental demand, customer acquisition cost, brand demand share and guardrail metrics at the appropriate cadence.
