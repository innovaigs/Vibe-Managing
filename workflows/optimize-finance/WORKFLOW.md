# Workflow: Optimize Finance

## Founder intents
"Improve our finance outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize economic viability, liquidity, capital allocation, treasury, and enterprise value, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `unit-economics-engine`, `capital-allocation`, `treasury-management` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track free cash flow, return on invested capital, cash runway and guardrail metrics at the appropriate cadence.
