# Workflow: Optimize Operations

## Founder intents
"Improve our operations outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize capacity, flow, reliability, service delivery, and multi-site execution, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `capacity-planning`, `service-delivery-control`, `multi-location-operations` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track on-time delivery, cycle time, cost per output and guardrail metrics at the appropriate cadence.
