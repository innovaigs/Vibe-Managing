# Workflow: Optimize Quality

## Founder intents
"Improve our quality outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize quality systems, process control, root cause, corrective action, and continuous improvement, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `quality-management-system`, `root-cause-analysis`, `statistical-process-control`, `corrective-preventive-action` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track first-pass yield, defect escape rate, corrective-action effectiveness and guardrail metrics at the appropriate cadence.
