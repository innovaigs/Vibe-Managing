# Workflow: Optimize Product

## Founder intents
"Improve our product outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize product discovery, strategy, portfolio, roadmap, economics, and adoption, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `product-strategy`, `continuous-product-discovery`, `product-roadmap`, `product-portfolio-management` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track product adoption, retention, product contribution margin and guardrail metrics at the appropriate cadence.
