# Workflow: Optimize People

## Founder intents
"Improve our people outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize workforce architecture, performance, capability, rewards, and employee experience, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `workforce-planning`, `compensation-and-rewards`, `performance-management` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track revenue per FTE, critical-role coverage, regrettable attrition and guardrail metrics at the appropriate cadence.
