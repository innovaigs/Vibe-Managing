# Workflow: Optimize International

## Founder intents
"Improve our international outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize cross-border entry, localization, economics, operations, and jurisdiction risk, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `international-market-entry`, `localization-strategy`, `cross-border-economics`, `jurisdiction-risk` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track market contribution, localization conversion, cross-border margin and guardrail metrics at the appropriate cadence.
