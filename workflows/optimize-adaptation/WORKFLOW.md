# Workflow: Optimize Business Adaptation

## Founder intents
"Improve our business adaptation outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize business archetype, industry, stage, geography, maturity, benchmark, and capability routing, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `business-archetype-classifier`, `industry-operating-profile`, `stage-and-maturity-assessment`, `regulatory-intensity-classifier`, `operating-model-fit`, `benchmark-calibration`, `dynamic-skill-routing`, `outcome-optimization` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track recommendation relevance, context completeness, outcome confidence and guardrail metrics at the appropriate cadence.
