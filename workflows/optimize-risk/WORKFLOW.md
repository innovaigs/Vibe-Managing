# Workflow: Optimize Risk

## Founder intents
"Improve our risk outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize enterprise risk, resilience, insurance, fraud prevention, and control effectiveness, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `enterprise-risk-management`, `insurance-coverage-analysis`, `fraud-control-design` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track residual risk, loss-event frequency, control effectiveness and guardrail metrics at the appropriate cadence.
