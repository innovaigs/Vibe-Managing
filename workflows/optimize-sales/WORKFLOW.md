# Workflow: Optimize Sales

## Founder intents
"Improve our sales outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize revenue conversion, coverage, commercial design, and deal quality, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `territory-and-quota-design`, `sales-compensation-design`, `enterprise-deal-strategy` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track win rate, quota attainment, sales cycle and guardrail metrics at the appropriate cadence.
