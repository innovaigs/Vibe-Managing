# Workflow: Optimize Customer Success

## Founder intents
"Improve our customer success outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize onboarding, value realization, retention, expansion, and customer intelligence, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `customer-onboarding-system`, `customer-health-scoring`, `retention-and-expansion`, `voice-of-customer-system` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track net revenue retention, time to value, customer health and guardrail metrics at the appropriate cadence.
