# Workflow: Optimize Strategy

## Founder intents
"Improve our strategy outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize direction, portfolio choices, business model, and competitive advantage, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `portfolio-strategy`, `business-model-design`, `strategic-scenario-planning` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track goal attainment, strategic initiative return, portfolio risk-adjusted value and guardrail metrics at the appropriate cadence.
