# Workflow: Optimize Growth

## Founder intents
"Improve our growth outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize repeatable growth systems, experimentation, expansion, and compounding, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `growth-modeling`, `experiment-portfolio`, `expansion-readiness` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track growth rate, incremental contribution, experiment learning velocity and guardrail metrics at the appropriate cadence.
