# Workflow: Optimize Supply Chain

## Founder intents
"Improve our supply chain outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize demand, sourcing, suppliers, inventory, logistics, and continuity, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `demand-planning`, `supplier-portfolio-management`, `inventory-policy`, `logistics-network-design` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track service level, inventory turns, perfect-order rate and guardrail metrics at the appropriate cadence.
