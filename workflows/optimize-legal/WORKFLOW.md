# Workflow: Optimize Legal

## Founder intents
"Improve our legal outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize obligation mapping, contract lifecycle, records, legal escalation, and defensibility, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `regulatory-obligation-mapping`, `contract-lifecycle-management`, `records-retention` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track material obligation coverage, contract leakage, legal issue cycle time and guardrail metrics at the appropriate cadence.
