# Workflow: Optimize Data & Analytics

## Founder intents
"Improve our data & analytics outcomes." · "What is holding this part of the company back?" · "Build and execute the best plan for this area."

## Objective
Optimize trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence, subject to company cash, capacity, safety, legal, privacy, people, trust, and strategic constraints.
...
3. **Diagnose:** invoke `metric-governance`, `data-quality-management`, `causal-decision-analysis`, `decision-intelligence` as required; distinguish evidence from assumptions and symptoms from causes.
...
7. **Monitor:** track trusted-data coverage, decision latency, forecast accuracy and guardrail metrics at the appropriate cadence.
