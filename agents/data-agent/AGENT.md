...
## Mission
Own trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence and improve company outcomes using evidence, explicit constraints, approved authority, and closed-loop learning.
