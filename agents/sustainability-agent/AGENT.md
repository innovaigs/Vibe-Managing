...
## Mission
Own material impacts, resource efficiency, resilience, and defensible reporting and improve company outcomes using evidence, explicit constraints, approved authority, and closed-loop learning.
...
- `resource-efficiency`
- `impact-measurement`
- `climate-and-resource-resilience`
