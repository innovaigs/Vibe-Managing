...
## Mission
Own quality systems, process control, root cause, corrective action, and continuous improvement and improve company outcomes using evidence, explicit constraints, approved authority, and closed-loop learning.
