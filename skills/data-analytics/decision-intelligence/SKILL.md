...
description: Turn a consequential decision into explicit objectives, options, evidence, uncertainty, tradeoffs, and learning commitments. Use when a founder or agent needs an evidence-backed decision intelligence decision or operating plan.
metadata:
  ...
  related_skills: "metric-governance, data-quality-management"
  owned_by_agents: "data-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Decision Intelligence

## Purpose
Turn a consequential decision into explicit objectives, options, evidence, uncertainty, tradeoffs, and learning commitments. It operationalizes trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a decision intelligence diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Frame decision.** Produce evidence, confidence, and a decision implication before continuing.
2. **define value model.** Produce evidence, confidence, and a decision implication before continuing.
3. **generate options.** Produce evidence, confidence, and a decision implication before continuing.
4. **quantify uncertainty.** Produce evidence, confidence, and a decision implication before continuing.
5. **assess downside and reversibility.** Produce evidence, confidence, and a decision implication before continuing.
6. **recommend.** Produce evidence, confidence, and a decision implication before continuing.
7. **record learning plan.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `decision value` — baseline, target, actual, trend, confidence, and owner.
- `calibration` — baseline, target, actual, trend, confidence, and owner.
- `time to decision` — baseline, target, actual, trend, confidence, and owner.
- `outcome variance` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use decision intelligence to improve our outcome without exceeding our cash, risk, or capacity limits."
