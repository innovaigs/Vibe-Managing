...
description: Create one trusted definition, owner, source, lineage, target, and decision use for every material business metric. Use when a founder or agent needs an evidence-backed metric governance decision or operating plan.
metadata:
  domain: data-analytics
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, data_analytics"
  writes: "data_analytics, metrics, decisions, strategy"
  related_skills: "data-quality-management, decision-intelligence"
  owned_by_agents: "data-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Metric Governance

## Purpose
Create one trusted definition, owner, source, lineage, target, and decision use for every material business metric. It operationalizes trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a metric governance diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory metrics.** Produce evidence, confidence, and a decision implication before continuing.
2. **resolve semantic conflicts.** Produce evidence, confidence, and a decision implication before continuing.
3. **define formula and grain.** Produce evidence, confidence, and a decision implication before continuing.
4. **assign owner.** Produce evidence, confidence, and a decision implication before continuing.
5. **document lineage.** Produce evidence, confidence, and a decision implication before continuing.
6. **certify and version.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/data-analytics.md`](../../../references/domain-playbooks/data-analytics.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `certified metric coverage` — baseline, target, actual, trend, confidence, and owner.
- `definition conflicts` — baseline, target, actual, trend, confidence, and owner.
- `freshness` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use metric governance to improve our outcome without exceeding our cash, risk, or capacity limits."
