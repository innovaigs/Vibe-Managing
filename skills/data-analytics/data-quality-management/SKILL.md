...
description: Measure and improve data completeness, validity, consistency, uniqueness, timeliness, and lineage according to decision risk. Use when a founder or agent needs an evidence-backed data quality management decision or operating plan.
metadata:
  ...
  related_skills: "metric-governance, decision-intelligence"
...
## Purpose
Measure and improve data completeness, validity, consistency, uniqueness, timeliness, and lineage according to decision risk. It operationalizes trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a data quality management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Identify critical data elements.** Produce evidence, confidence, and a decision implication before continuing.
2. **define rules.** Produce evidence, confidence, and a decision implication before continuing.
3. **profile data.** Produce evidence, confidence, and a decision implication before continuing.
4. **score impact.** Produce evidence, confidence, and a decision implication before continuing.
5. **trace root cause.** Produce evidence, confidence, and a decision implication before continuing.
6. **remediate source.** Produce evidence, confidence, and a decision implication before continuing.
7. **monitor control.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `critical-data quality` — baseline, target, actual, trend, confidence, and owner.
- `defect recurrence` — baseline, target, actual, trend, confidence, and owner.
- `time to remediation` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use data quality management to improve our outcome without exceeding our cash, risk, or capacity limits."
