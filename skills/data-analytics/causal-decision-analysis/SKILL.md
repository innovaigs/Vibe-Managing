---
name: causal-decision-analysis
description: Distinguish correlation from likely causal impact using appropriate experiments, quasi-experiments, and uncertainty reporting. Use when a founder or agent needs an evidence-backed causal decision analysis decision or operating plan.
metadata:
  ...
  related_skills: "metric-governance, data-quality-management, decision-intelligence"
...
## Purpose
Distinguish correlation from likely causal impact using appropriate experiments, quasi-experiments, and uncertainty reporting. It operationalizes trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a causal decision analysis diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define intervention and counterfactual.** Produce evidence, confidence, and a decision implication before continuing.
2. **draw causal assumptions.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify bias.** Produce evidence, confidence, and a decision implication before continuing.
4. **choose design.** Produce evidence, confidence, and a decision implication before continuing.
5. **estimate effect.** Produce evidence, confidence, and a decision implication before continuing.
6. **test robustness.** Produce evidence, confidence, and a decision implication before continuing.
7. **state limits.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `decision confidence` — baseline, target, actual, trend, confidence, and owner.
- `causal estimate stability` — baseline, target, actual, trend, confidence, and owner.
- `avoided false attribution` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use causal decision analysis to improve our outcome without exceeding our cash, risk, or capacity limits."
