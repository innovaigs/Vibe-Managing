...
description: Design flows, nodes, modes, partners, and buffers that achieve service at lowest risk-adjusted landed cost. Use when a founder or agent needs an evidence-backed logistics network design decision or operating plan.
metadata:
  domain: supply-chain
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "demand-planning, supplier-portfolio-management, enterprise-risk-management"
  owned_by_agents: "supply-chain-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Logistics Network Design

## Purpose
Design flows, nodes, modes, partners, and buffers that achieve service at lowest risk-adjusted landed cost. It operationalizes demand, sourcing, suppliers, inventory, logistics, and continuity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a logistics network design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map demand and origins.** Produce evidence, confidence, and a decision implication before continuing.
2. **calculate landed cost.** Produce evidence, confidence, and a decision implication before continuing.
3. **model service and capacity.** Produce evidence, confidence, and a decision implication before continuing.
4. **compare network scenarios.** Produce evidence, confidence, and a decision implication before continuing.
5. **test disruption.** Produce evidence, confidence, and a decision implication before continuing.
6. **phase transition.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `landed cost` — baseline, target, actual, trend, confidence, and owner.
- `on-time-in-full` — baseline, target, actual, trend, confidence, and owner.
- `transit variability` — baseline, target, actual, trend, confidence, and owner.
- `network resilience` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use logistics network design to improve our outcome without exceeding our cash, risk, or capacity limits."
