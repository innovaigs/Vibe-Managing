...
description: Set replenishment, safety stock, reorder, service, and disposition policies by economic and risk segment. Use when a founder or agent needs an evidence-backed inventory policy decision or operating plan.
metadata:
  domain: supply-chain
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Set replenishment, safety stock, reorder, service, and disposition policies by economic and risk segment. It operationalizes demand, sourcing, suppliers, inventory, logistics, and continuity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a inventory policy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Segment items.** Produce evidence, confidence, and a decision implication before continuing.
2. **estimate demand and lead-time variability.** Produce evidence, confidence, and a decision implication before continuing.
3. **set service target.** Produce evidence, confidence, and a decision implication before continuing.
4. **calculate safety stock and reorder point.** Produce evidence, confidence, and a decision implication before continuing.
5. **define exception and obsolescence rules.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `fill rate` — baseline, target, actual, trend, confidence, and owner.
- `stockouts` — baseline, target, actual, trend, confidence, and owner.
- `turns` — baseline, target, actual, trend, confidence, and owner.
- `aged inventory` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use inventory policy to improve our outcome without exceeding our cash, risk, or capacity limits."
