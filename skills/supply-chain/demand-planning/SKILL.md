...
description: Create a consensus demand view by item, location, channel, customer, and horizon with quantified uncertainty. Use when a founder or agent needs an evidence-backed demand planning decision or operating plan.
metadata:
  domain: supply-chain
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "supplier-portfolio-management, enterprise-risk-management"
...
## Purpose
Create a consensus demand view by item, location, channel, customer, and horizon with quantified uncertainty. It operationalizes demand, sourcing, suppliers, inventory, logistics, and continuity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a demand planning diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Clean history.** Produce evidence, confidence, and a decision implication before continuing.
2. **separate baseline and events.** Produce evidence, confidence, and a decision implication before continuing.
3. **select forecast.** Produce evidence, confidence, and a decision implication before continuing.
4. **incorporate commercial intelligence.** Produce evidence, confidence, and a decision implication before continuing.
5. **reconcile hierarchy.** Produce evidence, confidence, and a decision implication before continuing.
6. **set confidence and bias controls.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `forecast accuracy` — baseline, target, actual, trend, confidence, and owner.
- `bias` — baseline, target, actual, trend, confidence, and owner.
- `service level` — baseline, target, actual, trend, confidence, and owner.
- `obsolete exposure` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use demand planning to improve our outcome without exceeding our cash, risk, or capacity limits."
