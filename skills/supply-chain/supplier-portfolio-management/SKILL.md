---
name: supplier-portfolio-management
description: Segment, select, develop, monitor, and diversify suppliers based on value, risk, quality, capacity, and total cost. Use when a founder or agent needs an evidence-backed supplier portfolio management decision or operating plan.
metadata:
  domain: supply-chain
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, supply_chain"
  writes: "supply_chain, metrics, decisions, strategy"
  related_skills: "demand-planning, enterprise-risk-management"
  owned_by_agents: "supply-chain-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Supplier Portfolio Management

## Purpose
Segment, select, develop, monitor, and diversify suppliers based on value, risk, quality, capacity, and total cost. It operationalizes demand, sourcing, suppliers, inventory, logistics, and continuity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a supplier portfolio management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify criticality.** Produce evidence, confidence, and a decision implication before continuing.
2. **calculate total cost.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess capability and concentration.** Produce evidence, confidence, and a decision implication before continuing.
4. **define relationship model.** Produce evidence, confidence, and a decision implication before continuing.
5. **monitor scorecard.** Produce evidence, confidence, and a decision implication before continuing.
6. **create alternatives.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/supply-chain.md`](../../../references/domain-playbooks/supply-chain.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `supplier quality` — baseline, target, actual, trend, confidence, and owner.
- `on-time delivery` — baseline, target, actual, trend, confidence, and owner.
- `concentration` — baseline, target, actual, trend, confidence, and owner.
- `total cost` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use supplier portfolio management to improve our outcome without exceeding our cash, risk, or capacity limits."
