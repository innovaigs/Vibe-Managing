...
description: Build a quantified growth equation that explains how acquisition, conversion, retention, price, mix, and capacity create growth. Use when a founder or agent needs an evidence-backed growth modeling decision or operating plan.
metadata:
  domain: growth
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "experiment-portfolio, unit-economics-engine"
...
## Purpose
Build a quantified growth equation that explains how acquisition, conversion, retention, price, mix, and capacity create growth. It operationalizes repeatable growth systems, experimentation, expansion, and compounding for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a growth modeling diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Decompose revenue.** Produce evidence, confidence, and a decision implication before continuing.
2. **establish baselines.** Produce evidence, confidence, and a decision implication before continuing.
3. **quantify lever elasticity.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify constraint.** Produce evidence, confidence, and a decision implication before continuing.
5. **model interactions.** Produce evidence, confidence, and a decision implication before continuing.
6. **set leading indicators.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `growth rate` — baseline, target, actual, trend, confidence, and owner.
- `lever contribution` — baseline, target, actual, trend, confidence, and owner.
- `forecast error` — baseline, target, actual, trend, confidence, and owner.
- `constraint relief` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use growth modeling to improve our outcome without exceeding our cash, risk, or capacity limits."
