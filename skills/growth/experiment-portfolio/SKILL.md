---
name: experiment-portfolio
description: Run a balanced portfolio of growth experiments with explicit hypotheses, economics, guardrails, and stopping rules. Use when a founder or agent needs an evidence-backed growth experiment portfolio decision or operating plan.
metadata:
  domain: growth
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "growth-modeling, unit-economics-engine"
  owned_by_agents: "growth-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Growth Experiment Portfolio

## Purpose
Run a balanced portfolio of growth experiments with explicit hypotheses, economics, guardrails, and stopping rules. It operationalizes repeatable growth systems, experimentation, expansion, and compounding for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a growth experiment portfolio diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Generate hypotheses.** Produce evidence, confidence, and a decision implication before continuing.
2. **score evidence and upside.** Produce evidence, confidence, and a decision implication before continuing.
3. **design minimum viable tests.** Produce evidence, confidence, and a decision implication before continuing.
4. **allocate test budget.** Produce evidence, confidence, and a decision implication before continuing.
5. **apply sequential stop/scale rules.** Produce evidence, confidence, and a decision implication before continuing.
6. **capture learning.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `validated learning per dollar` — baseline, target, actual, trend, confidence, and owner.
- `experiment velocity` — baseline, target, actual, trend, confidence, and owner.
- `scaled-test return` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use growth experiment portfolio to improve our outcome without exceeding our cash, risk, or capacity limits."
