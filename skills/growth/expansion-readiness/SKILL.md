...
description: Determine whether the company is ready to expand into a new channel, segment, product, or geography without breaking the core. Use when a founder or agent needs an evidence-backed expansion readiness decision or operating plan.
metadata:
  domain: growth
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, growth"
  writes: "growth, metrics, decisions, strategy"
  related_skills: "growth-modeling, experiment-portfolio, unit-economics-engine"
  owned_by_agents: "growth-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Expansion Readiness

## Purpose
Determine whether the company is ready to expand into a new channel, segment, product, or geography without breaking the core. It operationalizes repeatable growth systems, experimentation, expansion, and compounding for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a expansion readiness diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Verify repeatability.** Produce evidence, confidence, and a decision implication before continuing.
2. **test capacity and management bandwidth.** Produce evidence, confidence, and a decision implication before continuing.
3. **model cash and downside.** Produce evidence, confidence, and a decision implication before continuing.
4. **map dependencies.** Produce evidence, confidence, and a decision implication before continuing.
5. **define reversible entry.** Produce evidence, confidence, and a decision implication before continuing.
6. **set kill criteria.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/growth.md`](../../../references/domain-playbooks/growth.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `core stability` — baseline, target, actual, trend, confidence, and owner.
- `expansion payback` — baseline, target, actual, trend, confidence, and owner.
- `readiness score` — baseline, target, actual, trend, confidence, and owner.
- `downside exposure` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use expansion readiness to improve our outcome without exceeding our cash, risk, or capacity limits."
