...
description: Choose the customer, problem, differentiated value, business outcome, and capabilities that define a winning product direction. Use when a founder or agent needs an evidence-backed product strategy decision or operating plan.
metadata:
  domain: product
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "continuous-product-discovery, unit-economics-engine"
...
## Purpose
Choose the customer, problem, differentiated value, business outcome, and capabilities that define a winning product direction. It operationalizes product discovery, strategy, portfolio, roadmap, economics, and adoption for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a product strategy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define strategic context.** Produce evidence, confidence, and a decision implication before continuing.
2. **choose target and problem.** Produce evidence, confidence, and a decision implication before continuing.
3. **quantify value.** Produce evidence, confidence, and a decision implication before continuing.
4. **assess alternatives.** Produce evidence, confidence, and a decision implication before continuing.
5. **define advantage and economics.** Produce evidence, confidence, and a decision implication before continuing.
6. **set product outcomes and guardrails.** Produce evidence, confidence, and a decision implication before continuing.
...
- `willingness to pay` — baseline, target, actual, trend, confidence, and owner.
- `product contribution` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use product strategy to improve our outcome without exceeding our cash, risk, or capacity limits."
