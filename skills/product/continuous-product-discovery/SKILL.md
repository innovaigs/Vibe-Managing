---
name: continuous-product-discovery
description: Continuously reduce customer, solution, usability, feasibility, and viability uncertainty before large commitments. Use when a founder or agent needs an evidence-backed continuous product discovery decision or operating plan.
metadata:
  domain: product
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, product"
  writes: "product, metrics, decisions, strategy"
  related_skills: "product-strategy, unit-economics-engine"
  owned_by_agents: "product-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Continuous Product Discovery

## Purpose
Continuously reduce customer, solution, usability, feasibility, and viability uncertainty before large commitments. It operationalizes product discovery, strategy, portfolio, roadmap, economics, and adoption for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a continuous product discovery diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map outcomes to opportunities.** Produce evidence, confidence, and a decision implication before continuing.
2. **gather evidence.** Produce evidence, confidence, and a decision implication before continuing.
3. **prioritize uncertainty.** Produce evidence, confidence, and a decision implication before continuing.
4. **test assumptions cheaply.** Produce evidence, confidence, and a decision implication before continuing.
5. **triangulate evidence.** Produce evidence, confidence, and a decision implication before continuing.
6. **update opportunity tree.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/product.md`](../../../references/domain-playbooks/product.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `assumption burn-down` — baseline, target, actual, trend, confidence, and owner.
- `evidence quality` — baseline, target, actual, trend, confidence, and owner.
- `discovery-to-delivery ratio` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use continuous product discovery to improve our outcome without exceeding our cash, risk, or capacity limits."
