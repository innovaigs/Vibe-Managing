...
description: Sequence product outcomes and bets around evidence, dependencies, capacity, risk, and strategic value rather than feature promises. Use when a founder or agent needs an evidence-backed product roadmap decision or operating plan.
metadata:
  domain: product
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Sequence product outcomes and bets around evidence, dependencies, capacity, risk, and strategic value rather than feature promises. It operationalizes product discovery, strategy, portfolio, roadmap, economics, and adoption for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a product roadmap diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Translate strategy to outcomes.** Produce evidence, confidence, and a decision implication before continuing.
2. **score opportunities.** Produce evidence, confidence, and a decision implication before continuing.
3. **map dependencies.** Produce evidence, confidence, and a decision implication before continuing.
4. **allocate capacity horizons.** Produce evidence, confidence, and a decision implication before continuing.
5. **expose uncertainty.** Produce evidence, confidence, and a decision implication before continuing.
6. **set review triggers.** Produce evidence, confidence, and a decision implication before continuing.
...
- `roadmap confidence` — baseline, target, actual, trend, confidence, and owner.
- `dependency aging` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use product roadmap to improve our outcome without exceeding our cash, risk, or capacity limits."
