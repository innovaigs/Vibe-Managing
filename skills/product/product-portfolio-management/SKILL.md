...
description: Manage offerings across lifecycle, strategic role, economics, customer value, and investment need. Use when a founder or agent needs an evidence-backed product portfolio management decision or operating plan.
metadata:
  domain: product
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "product-strategy, continuous-product-discovery, unit-economics-engine"
  owned_by_agents: "product-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Product Portfolio Management

## Purpose
Manage offerings across lifecycle, strategic role, economics, customer value, and investment need. It operationalizes product discovery, strategy, portfolio, roadmap, economics, and adoption for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a product portfolio management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify lifecycle and role.** Produce evidence, confidence, and a decision implication before continuing.
2. **normalize economics.** Produce evidence, confidence, and a decision implication before continuing.
3. **measure strategic fit.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify cannibalization and dependencies.** Produce evidence, confidence, and a decision implication before continuing.
5. **allocate investment.** Produce evidence, confidence, and a decision implication before continuing.
6. **set sunset criteria.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `portfolio contribution` — baseline, target, actual, trend, confidence, and owner.
- `investment efficiency` — baseline, target, actual, trend, confidence, and owner.
- `complexity cost` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use product portfolio management to improve our outcome without exceeding our cash, risk, or capacity limits."
