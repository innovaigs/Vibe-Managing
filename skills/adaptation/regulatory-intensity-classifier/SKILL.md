---
name: regulatory-intensity-classifier
description: Determine how strongly legal, safety, financial, clinical, employment, privacy, or sector rules should constrain routing and autonomy. Use when a founder or agent needs an evidence-backed regulatory intensity classifier decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Regulatory Intensity Classifier

## Purpose
Determine how strongly legal, safety, financial, clinical, employment, privacy, or sector rules should constrain routing and autonomy. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a regulatory intensity classifier diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map activities, data, people, assets and jurisdictions.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify regulated touchpoints.** Produce evidence, confidence, and a decision implication before continuing.
3. **score consequence and ambiguity.** Produce evidence, confidence, and a decision implication before continuing.
4. **set specialist gates.** Produce evidence, confidence, and a decision implication before continuing.
5. **lower autonomy.** Produce evidence, confidence, and a decision implication before continuing.
6. **Integrate.** Quantify cross-functional effects, dependencies, uncertainty, and opportunity cost in the Business Digital Twin.
7. **Decide.** Recommend the smallest action portfolio that clears hard constraints and maximizes risk-adjusted expected value.
8. **Learn.** Define leading indicators, review date, expected outcome, and conditions to stop, scale, reverse, or escalate.
...
## KPIs
- `correct escalation` — baseline, target, actual, trend, confidence, and owner.
- `regulatory coverage` — baseline, target, actual, trend, confidence, and owner.
- `unsafe action prevention` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use regulatory intensity classifier to improve our outcome without exceeding our cash, risk, or capacity limits."
