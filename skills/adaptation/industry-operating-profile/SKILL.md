---
name: industry-operating-profile
description: Load industry-specific economics, constraints, metrics, risks, cadence, and specialist boundaries without hard-coding one-size-fits-all advice. Use when a founder or agent needs an evidence-backed industry operating profile decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, adaptation"
  writes: "adaptation, metrics, decisions, strategy"
  related_skills: "business-archetype-classifier, dynamic-skill-routing"
  owned_by_agents: "adaptation-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Industry Operating Profile

## Purpose
Load industry-specific economics, constraints, metrics, risks, cadence, and specialist boundaries without hard-coding one-size-fits-all advice. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a industry operating profile diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Resolve industry and subindustry.** Produce evidence, confidence, and a decision implication before continuing.
2. **load profile.** Produce evidence, confidence, and a decision implication before continuing.
3. **validate local differences.** Produce evidence, confidence, and a decision implication before continuing.
4. **map critical value chain.** Produce evidence, confidence, and a decision implication before continuing.
5. **apply metrics and guardrails.** Produce evidence, confidence, and a decision implication before continuing.
6. **record overrides.** Produce evidence, confidence, and a decision implication before continuing.
7. **Integrate.** Quantify cross-functional effects, dependencies, uncertainty, and opportunity cost in the Business Digital Twin.
8. **Decide.** Recommend the smallest action portfolio that clears hard constraints and maximizes risk-adjusted expected value.
9. **Learn.** Define leading indicators, review date, expected outcome, and conditions to stop, scale, reverse, or escalate.

Read [`references/domain-playbooks/adaptation.md`](../../../references/domain-playbooks/adaptation.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `profile coverage` — baseline, target, actual, trend, confidence, and owner.
- `local override quality` — baseline, target, actual, trend, confidence, and owner.
- `recommendation relevance` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use industry operating profile to improve our outcome without exceeding our cash, risk, or capacity limits."
