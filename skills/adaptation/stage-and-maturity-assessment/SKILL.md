---
name: stage-and-maturity-assessment
description: Assess lifecycle stage and functional maturity so recommendations match what the company can absorb now. Use when a founder or agent needs an evidence-backed stage & maturity assessment decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Stage & Maturity Assessment

## Purpose
Assess lifecycle stage and functional maturity so recommendations match what the company can absorb now. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a stage & maturity assessment diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify lifecycle.** Produce evidence, confidence, and a decision implication before continuing.
2. **score management system maturity.** Produce evidence, confidence, and a decision implication before continuing.
3. **test evidence.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify weakest enabling capability.** Produce evidence, confidence, and a decision implication before continuing.
5. **set next maturity target.** Produce evidence, confidence, and a decision implication before continuing.
6. **avoid premature complexity.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `maturity progression` — baseline, target, actual, trend, confidence, and owner.
- `adoption` — baseline, target, actual, trend, confidence, and owner.
- `complexity avoided` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use stage & maturity assessment to improve our outcome without exceeding our cash, risk, or capacity limits."
