...
description: Use external or internal benchmarks responsibly by normalizing definitions, cohorts, scale, maturity, and business model. Use when a founder or agent needs an evidence-backed benchmark calibration decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Benchmark Calibration

## Purpose
Use external or internal benchmarks responsibly by normalizing definitions, cohorts, scale, maturity, and business model. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a benchmark calibration diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define decision and metric.** Produce evidence, confidence, and a decision implication before continuing.
2. **verify formula.** Produce evidence, confidence, and a decision implication before continuing.
3. **select comparable cohort.** Produce evidence, confidence, and a decision implication before continuing.
4. **normalize.** Produce evidence, confidence, and a decision implication before continuing.
5. **estimate range and uncertainty.** Produce evidence, confidence, and a decision implication before continuing.
6. **explain non-comparability.** Produce evidence, confidence, and a decision implication before continuing.
7. **set internal target.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `benchmark comparability` — baseline, target, actual, trend, confidence, and owner.
- `target calibration` — baseline, target, actual, trend, confidence, and owner.
- `false-comparison avoidance` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use benchmark calibration to improve our outcome without exceeding our cash, risk, or capacity limits."
