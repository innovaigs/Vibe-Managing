...
description: Choose the highest-value feasible action portfolio across financial, customer, operational, people, risk, and strategic outcomes. Use when a founder or agent needs an evidence-backed outcome optimization decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Outcome Optimization

## Purpose
Choose the highest-value feasible action portfolio across financial, customer, operational, people, risk, and strategic outcomes. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a outcome optimization diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define utility and hard constraints.** Produce evidence, confidence, and a decision implication before continuing.
2. **generate options.** Produce evidence, confidence, and a decision implication before continuing.
3. **estimate distributions.** Produce evidence, confidence, and a decision implication before continuing.
4. **account for dependencies and opportunity cost.** Produce evidence, confidence, and a decision implication before continuing.
5. **optimize portfolio.** Produce evidence, confidence, and a decision implication before continuing.
6. **test robustness.** Produce evidence, confidence, and a decision implication before continuing.
7. **set learning loop.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `risk-adjusted expected value` — baseline, target, actual, trend, confidence, and owner.
- `constraint compliance` — baseline, target, actual, trend, confidence, and owner.
- `realized outcome` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use outcome optimization to improve our outcome without exceeding our cash, risk, or capacity limits."
