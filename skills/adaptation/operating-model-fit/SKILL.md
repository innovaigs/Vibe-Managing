---
name: operating-model-fit
description: Select the right balance of centralization, standardization, autonomy, specialization, and coordination for the company's context. Use when a founder or agent needs an evidence-backed operating model fit decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "business-archetype-classifier, industry-operating-profile, dynamic-skill-routing"
  owned_by_agents: "adaptation-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Operating Model Fit

## Purpose
Select the right balance of centralization, standardization, autonomy, specialization, and coordination for the company's context. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a operating model fit diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map value streams and variability.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify scale and local needs.** Produce evidence, confidence, and a decision implication before continuing.
3. **define decision rights.** Produce evidence, confidence, and a decision implication before continuing.
4. **choose structural pattern.** Produce evidence, confidence, and a decision implication before continuing.
5. **test interfaces.** Produce evidence, confidence, and a decision implication before continuing.
6. **set evolution triggers.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `decision speed` — baseline, target, actual, trend, confidence, and owner.
- `handoff quality` — baseline, target, actual, trend, confidence, and owner.
- `local performance variance` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use operating model fit to improve our outcome without exceeding our cash, risk, or capacity limits."
