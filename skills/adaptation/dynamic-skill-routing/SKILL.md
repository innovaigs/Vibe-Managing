...
description: Select the smallest sufficient set and sequence of skills, agents, tools, approvals, and monitoring for a founder intent. Use when a founder or agent needs an evidence-backed dynamic skill routing decision or operating plan.
metadata:
  domain: adaptation
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "business-archetype-classifier, industry-operating-profile"
  owned_by_agents: "adaptation-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Dynamic Skill Routing

## Purpose
Select the smallest sufficient set and sequence of skills, agents, tools, approvals, and monitoring for a founder intent. It operationalizes business archetype, industry, stage, geography, maturity, benchmark, and capability routing for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a dynamic skill routing diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify intent and stakes.** Produce evidence, confidence, and a decision implication before continuing.
2. **load adaptation context.** Produce evidence, confidence, and a decision implication before continuing.
3. **decompose outcome.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify dependencies.** Produce evidence, confidence, and a decision implication before continuing.
5. **minimize calls.** Produce evidence, confidence, and a decision implication before continuing.
6. **set parallel work.** Produce evidence, confidence, and a decision implication before continuing.
7. **determine control gates.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `routing precision` — baseline, target, actual, trend, confidence, and owner.
- `time to decision` — baseline, target, actual, trend, confidence, and owner.
- `unnecessary skill calls` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use dynamic skill routing to improve our outcome without exceeding our cash, risk, or capacity limits."
