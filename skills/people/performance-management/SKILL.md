...
description: Create a fair operating system for expectations, feedback, development, accountability, and performance decisions. Use when a founder or agent needs an evidence-backed performance management decision or operating plan.
metadata:
  domain: people
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, people"
  writes: "people, metrics, decisions, strategy"
  related_skills: "organizational-design, workforce-planning, change-management"
  owned_by_agents: "people-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Performance Management

## Purpose
Create a fair operating system for expectations, feedback, development, accountability, and performance decisions. It operationalizes workforce architecture, performance, capability, rewards, and employee experience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a performance management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Clarify outcomes and behaviors.** Produce evidence, confidence, and a decision implication before continuing.
2. **calibrate measures.** Produce evidence, confidence, and a decision implication before continuing.
3. **set check-in cadence.** Produce evidence, confidence, and a decision implication before continuing.
4. **separate coaching from consequences.** Produce evidence, confidence, and a decision implication before continuing.
5. **calibrate ratings.** Produce evidence, confidence, and a decision implication before continuing.
6. **document decisions.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/people.md`](../../../references/domain-playbooks/people.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `goal attainment` — baseline, target, actual, trend, confidence, and owner.
- `feedback timeliness` — baseline, target, actual, trend, confidence, and owner.
- `performance distribution` — baseline, target, actual, trend, confidence, and owner.
- `improvement-plan outcomes` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use performance management to improve our outcome without exceeding our cash, risk, or capacity limits."
