---
name: compensation-and-rewards
description: Design equitable, affordable rewards that attract, motivate, retain, and align people with outcomes. Use when a founder or agent needs an evidence-backed compensation & rewards decision or operating plan.
metadata:
  domain: people
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Compensation & Rewards

## Purpose
Design equitable, affordable rewards that attract, motivate, retain, and align people with outcomes. It operationalizes workforce architecture, performance, capability, rewards, and employee experience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a compensation & rewards diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define reward philosophy.** Produce evidence, confidence, and a decision implication before continuing.
2. **benchmark roles.** Produce evidence, confidence, and a decision implication before continuing.
3. **set ranges.** Produce evidence, confidence, and a decision implication before continuing.
4. **assess internal equity.** Produce evidence, confidence, and a decision implication before continuing.
5. **design incentives.** Produce evidence, confidence, and a decision implication before continuing.
6. **model total cost and behavior risk.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `range penetration` — baseline, target, actual, trend, confidence, and owner.
- `pay equity` — baseline, target, actual, trend, confidence, and owner.
- `regrettable attrition` — baseline, target, actual, trend, confidence, and owner.
- `incentive efficiency` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use compensation & rewards to improve our outcome without exceeding our cash, risk, or capacity limits."
