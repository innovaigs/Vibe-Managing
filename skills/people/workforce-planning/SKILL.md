...
description: Translate strategy and demand into the roles, capacity, skills, location, and labor model required over time. Use when a founder or agent needs an evidence-backed workforce planning decision or operating plan.
metadata:
  domain: people
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "organizational-design, change-management"
...
## Purpose
Translate strategy and demand into the roles, capacity, skills, location, and labor model required over time. It operationalizes workforce architecture, performance, capability, rewards, and employee experience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a workforce planning diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Model future work.** Produce evidence, confidence, and a decision implication before continuing.
2. **quantify capacity.** Produce evidence, confidence, and a decision implication before continuing.
3. **map capabilities.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify build/buy/borrow/automate options.** Produce evidence, confidence, and a decision implication before continuing.
5. **sequence roles.** Produce evidence, confidence, and a decision implication before continuing.
6. **test affordability.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `capacity gap` — baseline, target, actual, trend, confidence, and owner.
- `critical-skill coverage` — baseline, target, actual, trend, confidence, and owner.
- `labor productivity` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use workforce planning to improve our outcome without exceeding our cash, risk, or capacity limits."
