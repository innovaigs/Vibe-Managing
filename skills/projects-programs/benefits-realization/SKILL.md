...
description: Ensure completed initiatives produce the financial, customer, operational, people, or risk outcomes that justified them. Use when a founder or agent needs an evidence-backed benefits realization decision or operating plan.
metadata:
  domain: projects-programs
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, projects_programs"
  writes: "projects_programs, metrics, decisions, strategy"
  related_skills: "project-charter, schedule-and-dependency-risk"
  owned_by_agents: "pmo-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Benefits Realization

## Purpose
Ensure completed initiatives produce the financial, customer, operational, people, or risk outcomes that justified them. It operationalizes initiative delivery, dependencies, benefits, resources, and portfolio governance for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a benefits realization diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define benefit owner and baseline.** Produce evidence, confidence, and a decision implication before continuing.
2. **model benefit path.** Produce evidence, confidence, and a decision implication before continuing.
3. **instrument leading indicators.** Produce evidence, confidence, and a decision implication before continuing.
4. **verify adoption.** Produce evidence, confidence, and a decision implication before continuing.
5. **measure realized value.** Produce evidence, confidence, and a decision implication before continuing.
6. **sustain or correct.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/projects-programs.md`](../../../references/domain-playbooks/projects-programs.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `benefits realized` — baseline, target, actual, trend, confidence, and owner.
- `time to benefit` — baseline, target, actual, trend, confidence, and owner.
- `adoption` — baseline, target, actual, trend, confidence, and owner.
- `value leakage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use benefits realization to improve our outcome without exceeding our cash, risk, or capacity limits."
