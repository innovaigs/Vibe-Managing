---
name: schedule-and-dependency-risk
description: Build and control a dependency-aware schedule with confidence ranges, critical path, buffers, and recovery options. Use when a founder or agent needs an evidence-backed schedule & dependency risk decision or operating plan.
metadata:
  ...
  related_skills: "project-charter, benefits-realization"
  owned_by_agents: "pmo-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Schedule & Dependency Risk

## Purpose
Build and control a dependency-aware schedule with confidence ranges, critical path, buffers, and recovery options. It operationalizes initiative delivery, dependencies, benefits, resources, and portfolio governance for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a schedule & dependency risk diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Decompose deliverables.** Produce evidence, confidence, and a decision implication before continuing.
2. **sequence dependencies.** Produce evidence, confidence, and a decision implication before continuing.
3. **estimate ranges.** Produce evidence, confidence, and a decision implication before continuing.
4. **calculate critical path.** Produce evidence, confidence, and a decision implication before continuing.
5. **model resource constraints.** Produce evidence, confidence, and a decision implication before continuing.
6. **set buffers.** Produce evidence, confidence, and a decision implication before continuing.
7. **monitor variance.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `schedule confidence` — baseline, target, actual, trend, confidence, and owner.
- `critical-path slippage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use schedule & dependency risk to improve our outcome without exceeding our cash, risk, or capacity limits."
