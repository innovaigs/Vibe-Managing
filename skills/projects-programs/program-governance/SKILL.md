...
description: Coordinate related projects, shared resources, dependencies, risks, and decisions around a strategic outcome. Use when a founder or agent needs an evidence-backed program governance decision or operating plan.
metadata:
  ...
  related_skills: "project-charter, schedule-and-dependency-risk, benefits-realization"
  owned_by_agents: "pmo-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Program Governance

## Purpose
Coordinate related projects, shared resources, dependencies, risks, and decisions around a strategic outcome. It operationalizes initiative delivery, dependencies, benefits, resources, and portfolio governance for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a program governance diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define program outcomes.** Produce evidence, confidence, and a decision implication before continuing.
2. **map components.** Produce evidence, confidence, and a decision implication before continuing.
3. **establish governance.** Produce evidence, confidence, and a decision implication before continuing.
4. **integrate plans.** Produce evidence, confidence, and a decision implication before continuing.
5. **manage dependencies and change.** Produce evidence, confidence, and a decision implication before continuing.
6. **report outcomes.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `program outcome progress` — baseline, target, actual, trend, confidence, and owner.
- `cross-project blockage` — baseline, target, actual, trend, confidence, and owner.
- `decision latency` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use program governance to improve our outcome without exceeding our cash, risk, or capacity limits."
