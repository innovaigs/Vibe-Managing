...
description: Turn an approved outcome into a bounded project with value, scope, owner, resources, governance, risks, and success measures. Use when a founder or agent needs an evidence-backed project charter decision or operating plan.
metadata:
  ...
  related_skills: "schedule-and-dependency-risk, benefits-realization"
...
## Purpose
Turn an approved outcome into a bounded project with value, scope, owner, resources, governance, risks, and success measures. It operationalizes initiative delivery, dependencies, benefits, resources, and portfolio governance for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a project charter diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Clarify outcome.** Produce evidence, confidence, and a decision implication before continuing.
2. **define value and non-goals.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify stakeholders.** Produce evidence, confidence, and a decision implication before continuing.
4. **estimate work and resources.** Produce evidence, confidence, and a decision implication before continuing.
5. **set governance.** Produce evidence, confidence, and a decision implication before continuing.
6. **approve baseline.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `charter completeness` — baseline, target, actual, trend, confidence, and owner.
- `sponsor alignment` — baseline, target, actual, trend, confidence, and owner.
- `scope stability` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use project charter to improve our outcome without exceeding our cash, risk, or capacity limits."
