...
description: Reduce energy, water, material, waste, and emissions intensity while improving cost, resilience, and operational performance. Use when a founder or agent needs an evidence-backed resource efficiency decision or operating plan.
metadata:
  ...
  related_skills: "sustainability-materiality, enterprise-risk-management"
...
## Purpose
Reduce energy, water, material, waste, and emissions intensity while improving cost, resilience, and operational performance. It operationalizes material impacts, resource efficiency, resilience, and defensible reporting for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a resource efficiency diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Establish boundary and baseline.** Produce evidence, confidence, and a decision implication before continuing.
2. **map resource flow.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify losses.** Produce evidence, confidence, and a decision implication before continuing.
4. **rank interventions by economics and feasibility.** Produce evidence, confidence, and a decision implication before continuing.
5. **implement.** Produce evidence, confidence, and a decision implication before continuing.
6. **verify savings.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `resource intensity` — baseline, target, actual, trend, confidence, and owner.
- `verified savings` — baseline, target, actual, trend, confidence, and owner.
- `waste` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use resource efficiency to improve our outcome without exceeding our cash, risk, or capacity limits."
