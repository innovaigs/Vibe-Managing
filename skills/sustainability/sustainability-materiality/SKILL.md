---
name: sustainability-materiality
description: Identify environmental and social issues that are material to enterprise value and affected stakeholders without making unsupported claims. Use when a founder or agent needs an evidence-backed sustainability materiality decision or operating plan.
metadata:
  ...
  related_skills: "resource-efficiency, enterprise-risk-management"
  owned_by_agents: "sustainability-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Sustainability Materiality

## Purpose
Identify environmental and social issues that are material to enterprise value and affected stakeholders without making unsupported claims. It operationalizes material impacts, resource efficiency, resilience, and defensible reporting for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a sustainability materiality diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map value chain and stakeholders.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify impacts and dependencies.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess financial and impact materiality.** Produce evidence, confidence, and a decision implication before continuing.
4. **prioritize.** Produce evidence, confidence, and a decision implication before continuing.
5. **validate evidence.** Produce evidence, confidence, and a decision implication before continuing.
6. **govern claims.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `material-issue coverage` — baseline, target, actual, trend, confidence, and owner.
- `evidence quality` — baseline, target, actual, trend, confidence, and owner.
- `claim risk` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use sustainability materiality to improve our outcome without exceeding our cash, risk, or capacity limits."
