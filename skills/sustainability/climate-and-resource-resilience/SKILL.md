---
name: climate-and-resource-resilience
description: Assess physical and transition exposures that could disrupt sites, supply, demand, insurance, or economics and plan adaptive responses. Use when a founder or agent needs an evidence-backed climate & resource resilience decision or operating plan.
metadata:
...
# Skill: Climate & Resource Resilience

## Purpose
Assess physical and transition exposures that could disrupt sites, supply, demand, insurance, or economics and plan adaptive responses. It operationalizes material impacts, resource efficiency, resilience, and defensible reporting for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a climate & resource resilience diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map assets and dependencies.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify scenarios.** Produce evidence, confidence, and a decision implication before continuing.
3. **estimate exposure and vulnerability.** Produce evidence, confidence, and a decision implication before continuing.
4. **prioritize adaptation.** Produce evidence, confidence, and a decision implication before continuing.
5. **test continuity.** Produce evidence, confidence, and a decision implication before continuing.
6. **monitor signposts.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `exposure reduction` — baseline, target, actual, trend, confidence, and owner.
- `adaptation readiness` — baseline, target, actual, trend, confidence, and owner.
- `downtime avoided` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use climate & resource resilience to improve our outcome without exceeding our cash, risk, or capacity limits."
