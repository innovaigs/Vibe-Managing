...
description: Match demand to people, equipment, space, inventory, and partner capacity at the required service and cost level. Use when a founder or agent needs an evidence-backed capacity planning decision or operating plan.
metadata:
  domain: operations
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Match demand to people, equipment, space, inventory, and partner capacity at the required service and cost level. It operationalizes capacity, flow, reliability, service delivery, and multi-site execution for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a capacity planning diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Forecast demand by unit.** Produce evidence, confidence, and a decision implication before continuing.
2. **translate into workload.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify effective capacity.** Produce evidence, confidence, and a decision implication before continuing.
4. **model variability and queues.** Produce evidence, confidence, and a decision implication before continuing.
5. **choose buffers.** Produce evidence, confidence, and a decision implication before continuing.
6. **plan capacity actions.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `utilization` — baseline, target, actual, trend, confidence, and owner.
- `throughput` — baseline, target, actual, trend, confidence, and owner.
- `backlog` — baseline, target, actual, trend, confidence, and owner.
- `service level` — baseline, target, actual, trend, confidence, and owner.
- `cost per unit` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use capacity planning to improve our outcome without exceeding our cash, risk, or capacity limits."
