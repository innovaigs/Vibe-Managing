---
name: service-delivery-control
description: Control the complete promise-to-delivery system for consistent scope, quality, time, margin, and customer outcomes. Use when a founder or agent needs an evidence-backed service delivery control decision or operating plan.
metadata:
  domain: operations
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Service Delivery Control

## Purpose
Control the complete promise-to-delivery system for consistent scope, quality, time, margin, and customer outcomes. It operationalizes capacity, flow, reliability, service delivery, and multi-site execution for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a service delivery control diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define service promise.** Produce evidence, confidence, and a decision implication before continuing.
2. **map handoffs.** Produce evidence, confidence, and a decision implication before continuing.
3. **create control points.** Produce evidence, confidence, and a decision implication before continuing.
4. **track WIP and exceptions.** Produce evidence, confidence, and a decision implication before continuing.
5. **protect scope and margin.** Produce evidence, confidence, and a decision implication before continuing.
6. **close feedback loop.** Produce evidence, confidence, and a decision implication before continuing.
...
- `rework` — baseline, target, actual, trend, confidence, and owner.
- `scope leakage` — baseline, target, actual, trend, confidence, and owner.
- `delivery margin` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use service delivery control to improve our outcome without exceeding our cash, risk, or capacity limits."
