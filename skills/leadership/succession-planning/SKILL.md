...
description: Reduce dependency on key people and build credible successors for critical leadership and specialist roles. Use when a founder or agent needs an evidence-backed succession planning decision or operating plan.
metadata:
  domain: leadership
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, leadership"
  writes: "leadership, metrics, decisions, strategy"
  related_skills: "executive-decision-system, change-management, decision-rights-design"
  owned_by_agents: "leadership-coach-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Succession Planning

## Purpose
Reduce dependency on key people and build credible successors for critical leadership and specialist roles. It operationalizes decision quality, change, succession, executive leverage, and organizational clarity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a succession planning diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Identify critical roles.** Produce evidence, confidence, and a decision implication before continuing.
2. **define future capabilities.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess bench.** Produce evidence, confidence, and a decision implication before continuing.
4. **select successor paths.** Produce evidence, confidence, and a decision implication before continuing.
5. **create development assignments.** Produce evidence, confidence, and a decision implication before continuing.
6. **test emergency coverage.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/leadership.md`](../../../references/domain-playbooks/leadership.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `critical-role coverage` — baseline, target, actual, trend, confidence, and owner.
- `successor readiness` — baseline, target, actual, trend, confidence, and owner.
- `key-person concentration` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use succession planning to improve our outcome without exceeding our cash, risk, or capacity limits."
