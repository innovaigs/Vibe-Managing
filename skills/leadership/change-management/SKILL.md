...
description: Move a business from current to desired behavior while protecting continuity, trust, and adoption. Use when a founder or agent needs an evidence-backed change management decision or operating plan.
metadata:
  domain: leadership
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "executive-decision-system, decision-rights-design"
...
## Purpose
Move a business from current to desired behavior while protecting continuity, trust, and adoption. It operationalizes decision quality, change, succession, executive leverage, and organizational clarity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a change management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define case and impacts.** Produce evidence, confidence, and a decision implication before continuing.
2. **map stakeholders.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess readiness.** Produce evidence, confidence, and a decision implication before continuing.
4. **design participation and communication.** Produce evidence, confidence, and a decision implication before continuing.
5. **enable managers.** Produce evidence, confidence, and a decision implication before continuing.
6. **measure adoption and reinforce.** Produce evidence, confidence, and a decision implication before continuing.
...
- `proficiency` — baseline, target, actual, trend, confidence, and owner.
- `benefit realization` — baseline, target, actual, trend, confidence, and owner.
- `change fatigue` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use change management to improve our outcome without exceeding our cash, risk, or capacity limits."
