...
description: Improve the speed, quality, ownership, and learning of consequential leadership decisions. Use when a founder or agent needs an evidence-backed executive decision system decision or operating plan.
metadata:
  domain: leadership
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "change-management, decision-rights-design"
  owned_by_agents: "leadership-coach-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Executive Decision System

## Purpose
Improve the speed, quality, ownership, and learning of consequential leadership decisions. It operationalizes decision quality, change, succession, executive leverage, and organizational clarity for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a executive decision system diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify decision.** Produce evidence, confidence, and a decision implication before continuing.
2. **assign rights.** Produce evidence, confidence, and a decision implication before continuing.
3. **define evidence threshold.** Produce evidence, confidence, and a decision implication before continuing.
4. **surface assumptions and dissent.** Produce evidence, confidence, and a decision implication before continuing.
5. **decide with reversibility-aware speed.** Produce evidence, confidence, and a decision implication before continuing.
6. **record outcome review.** Produce evidence, confidence, and a decision implication before continuing.
...
- `reversal rate` — baseline, target, actual, trend, confidence, and owner.
- `decision outcome variance` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use executive decision system to improve our outcome without exceeding our cash, risk, or capacity limits."
