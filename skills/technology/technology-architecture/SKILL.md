...
description: Design a secure, scalable, supportable technology blueprint aligned to business capabilities and constraints. Use when a founder or agent needs an evidence-backed technology architecture decision or operating plan.
metadata:
  domain: technology
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, technology"
  writes: "technology, metrics, decisions, strategy"
  related_skills: "technology-vendor-selection, security-posture-assessment"
  owned_by_agents: "technology-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Technology Architecture

## Purpose
Design a secure, scalable, supportable technology blueprint aligned to business capabilities and constraints. It operationalizes architecture, systems portfolio, automation, reliability, cost, and technical leverage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a technology architecture diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map business capabilities.** Produce evidence, confidence, and a decision implication before continuing.
2. **inventory systems and dependencies.** Produce evidence, confidence, and a decision implication before continuing.
3. **define principles.** Produce evidence, confidence, and a decision implication before continuing.
4. **design target architecture.** Produce evidence, confidence, and a decision implication before continuing.
5. **sequence transitions.** Produce evidence, confidence, and a decision implication before continuing.
6. **quantify risk and cost.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/technology.md`](../../../references/domain-playbooks/technology.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `availability` — baseline, target, actual, trend, confidence, and owner.
- `integration reliability` — baseline, target, actual, trend, confidence, and owner.
- `architectural debt` — baseline, target, actual, trend, confidence, and owner.
- `cost per capability` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use technology architecture to improve our outcome without exceeding our cash, risk, or capacity limits."
