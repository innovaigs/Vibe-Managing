---
name: automation-portfolio-management
description: Select and govern automation and AI opportunities based on value, feasibility, control, adoption, and maintenance burden. Use when a founder or agent needs an evidence-backed automation portfolio management decision or operating plan.
metadata:
  domain: technology
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "technology-architecture, technology-vendor-selection, security-posture-assessment"
...
## Purpose
Select and govern automation and AI opportunities based on value, feasibility, control, adoption, and maintenance burden. It operationalizes architecture, systems portfolio, automation, reliability, cost, and technical leverage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a automation portfolio management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Discover tasks.** Produce evidence, confidence, and a decision implication before continuing.
2. **score value and risk.** Produce evidence, confidence, and a decision implication before continuing.
3. **redesign process first.** Produce evidence, confidence, and a decision implication before continuing.
4. **choose automation pattern.** Produce evidence, confidence, and a decision implication before continuing.
5. **set human control.** Produce evidence, confidence, and a decision implication before continuing.
6. **pilot.** Produce evidence, confidence, and a decision implication before continuing.
7. **monitor drift and exceptions.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `hours returned` — baseline, target, actual, trend, confidence, and owner.
- `error reduction` — baseline, target, actual, trend, confidence, and owner.
- `automation reliability` — baseline, target, actual, trend, confidence, and owner.
- `realized value` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use automation portfolio management to improve our outcome without exceeding our cash, risk, or capacity limits."
