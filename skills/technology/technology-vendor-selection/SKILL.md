...
description: Select systems and vendors through requirements, total cost, risk, interoperability, adoption, and exit analysis. Use when a founder or agent needs an evidence-backed technology vendor selection decision or operating plan.
metadata:
  domain: technology
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "technology-architecture, security-posture-assessment"
  owned_by_agents: "technology-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Technology Vendor Selection

## Purpose
Select systems and vendors through requirements, total cost, risk, interoperability, adoption, and exit analysis. It operationalizes architecture, systems portfolio, automation, reliability, cost, and technical leverage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a technology vendor selection diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define outcomes and requirements.** Produce evidence, confidence, and a decision implication before continuing.
2. **screen vendors.** Produce evidence, confidence, and a decision implication before continuing.
3. **test workflows.** Produce evidence, confidence, and a decision implication before continuing.
4. **assess security and data.** Produce evidence, confidence, and a decision implication before continuing.
5. **model total cost.** Produce evidence, confidence, and a decision implication before continuing.
6. **negotiate boundaries.** Produce evidence, confidence, and a decision implication before continuing.
7. **plan exit.** Produce evidence, confidence, and a decision implication before continuing.
...
- `total cost variance` — baseline, target, actual, trend, confidence, and owner.
- `adoption` — baseline, target, actual, trend, confidence, and owner.
- `vendor risk` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use technology vendor selection to improve our outcome without exceeding our cash, risk, or capacity limits."
