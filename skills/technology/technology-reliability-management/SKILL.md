---
name: technology-reliability-management
description: Define service objectives and operate incident, problem, change, capacity, and continuity controls for critical systems. Use when a founder or agent needs an evidence-backed technology reliability management decision or operating plan.
metadata:
  domain: technology
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Define service objectives and operate incident, problem, change, capacity, and continuity controls for critical systems. It operationalizes architecture, systems portfolio, automation, reliability, cost, and technical leverage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a technology reliability management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Tier services.** Produce evidence, confidence, and a decision implication before continuing.
2. **set SLOs.** Produce evidence, confidence, and a decision implication before continuing.
3. **instrument signals.** Produce evidence, confidence, and a decision implication before continuing.
4. **control changes.** Produce evidence, confidence, and a decision implication before continuing.
5. **manage incidents and problems.** Produce evidence, confidence, and a decision implication before continuing.
6. **test recovery.** Produce evidence, confidence, and a decision implication before continuing.
7. **review reliability economics.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `SLO attainment` — baseline, target, actual, trend, confidence, and owner.
- `change failure rate` — baseline, target, actual, trend, confidence, and owner.
- `recovery time` — baseline, target, actual, trend, confidence, and owner.
- `recurring incidents` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use technology reliability management to improve our outcome without exceeding our cash, risk, or capacity limits."
