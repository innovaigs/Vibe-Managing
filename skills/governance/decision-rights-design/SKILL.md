---
name: decision-rights-design
description: Clarify who proposes, provides input, decides, executes, and reviews each recurring class of business decision. Use when a founder or agent needs an evidence-backed decision rights design decision or operating plan.
metadata:
  domain: governance
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "policy-management, enterprise-risk-management"
  owned_by_agents: "governance-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Decision Rights Design

## Purpose
Clarify who proposes, provides input, decides, executes, and reviews each recurring class of business decision. It operationalizes decision rights, board effectiveness, policies, accountability, and stakeholder oversight for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a decision rights design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory decisions.** Produce evidence, confidence, and a decision implication before continuing.
2. **classify risk and reversibility.** Produce evidence, confidence, and a decision implication before continuing.
3. **assign roles.** Produce evidence, confidence, and a decision implication before continuing.
4. **set thresholds and escalation.** Produce evidence, confidence, and a decision implication before continuing.
5. **test conflicts.** Produce evidence, confidence, and a decision implication before continuing.
6. **publish and review.** Produce evidence, confidence, and a decision implication before continuing.
...
- `escalation accuracy` — baseline, target, actual, trend, confidence, and owner.
- `ownership conflicts` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use decision rights design to improve our outcome without exceeding our cash, risk, or capacity limits."
