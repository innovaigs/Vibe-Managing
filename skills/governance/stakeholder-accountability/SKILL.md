...
description: Map material stakeholders, commitments, tradeoffs, impacts, and communication responsibilities into decisions. Use when a founder or agent needs an evidence-backed stakeholder accountability decision or operating plan.
metadata:
  domain: governance
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Stakeholder Accountability

## Purpose
Map material stakeholders, commitments, tradeoffs, impacts, and communication responsibilities into decisions. It operationalizes decision rights, board effectiveness, policies, accountability, and stakeholder oversight for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a stakeholder accountability diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Identify stakeholders.** Produce evidence, confidence, and a decision implication before continuing.
2. **map power and impact.** Produce evidence, confidence, and a decision implication before continuing.
3. **capture commitments.** Produce evidence, confidence, and a decision implication before continuing.
4. **assess tradeoffs.** Produce evidence, confidence, and a decision implication before continuing.
5. **assign engagement.** Produce evidence, confidence, and a decision implication before continuing.
6. **track trust and outcomes.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `commitment completion` — baseline, target, actual, trend, confidence, and owner.
- `stakeholder risk` — baseline, target, actual, trend, confidence, and owner.
- `trust trend` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use stakeholder accountability to improve our outcome without exceeding our cash, risk, or capacity limits."
