---
name: board-operating-cadence
description: Run a decision-focused board cadence with timely information, strategic depth, risk oversight, and accountable follow-through. Use when a founder or agent needs an evidence-backed board operating cadence decision or operating plan.
metadata:
  domain: governance
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "decision-rights-design, policy-management, enterprise-risk-management"
  owned_by_agents: "governance-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Board Operating Cadence

## Purpose
Run a decision-focused board cadence with timely information, strategic depth, risk oversight, and accountable follow-through. It operationalizes decision rights, board effectiveness, policies, accountability, and stakeholder oversight for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a board operating cadence diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Set annual agenda.** Produce evidence, confidence, and a decision implication before continuing.
2. **define information standards.** Produce evidence, confidence, and a decision implication before continuing.
3. **prepare decision briefs.** Produce evidence, confidence, and a decision implication before continuing.
4. **surface risk and dissent.** Produce evidence, confidence, and a decision implication before continuing.
5. **record decisions.** Produce evidence, confidence, and a decision implication before continuing.
6. **track actions.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `board decision quality` — baseline, target, actual, trend, confidence, and owner.
- `action closure` — baseline, target, actual, trend, confidence, and owner.
- `information timeliness` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use board operating cadence to improve our outcome without exceeding our cash, risk, or capacity limits."
