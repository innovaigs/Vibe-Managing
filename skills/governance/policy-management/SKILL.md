...
description: Create, approve, communicate, attest, monitor, and retire policies as executable controls rather than static documents. Use when a founder or agent needs an evidence-backed policy management decision or operating plan.
metadata:
  domain: governance
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, governance"
  writes: "governance, metrics, decisions, strategy"
  related_skills: "decision-rights-design, enterprise-risk-management"
  owned_by_agents: "governance-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Policy Management

## Purpose
Create, approve, communicate, attest, monitor, and retire policies as executable controls rather than static documents. It operationalizes decision rights, board effectiveness, policies, accountability, and stakeholder oversight for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a policy management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Identify policy need.** Produce evidence, confidence, and a decision implication before continuing.
2. **define scope and owner.** Produce evidence, confidence, and a decision implication before continuing.
3. **draft control requirements.** Produce evidence, confidence, and a decision implication before continuing.
4. **review specialists.** Produce evidence, confidence, and a decision implication before continuing.
5. **approve.** Produce evidence, confidence, and a decision implication before continuing.
6. **train.** Produce evidence, confidence, and a decision implication before continuing.
7. **monitor.** Produce evidence, confidence, and a decision implication before continuing.
8. **version and retire.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/governance.md`](../../../references/domain-playbooks/governance.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `policy coverage` — baseline, target, actual, trend, confidence, and owner.
- `attestation` — baseline, target, actual, trend, confidence, and owner.
- `control exceptions` — baseline, target, actual, trend, confidence, and owner.
- `stale policies` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use policy management to improve our outcome without exceeding our cash, risk, or capacity limits."
