...
description: Control containment, correction, root cause, corrective action, effectiveness verification, and systemic prevention. Use when a founder or agent needs an evidence-backed corrective & preventive action decision or operating plan.
metadata:
  domain: quality
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, quality"
  writes: "quality, metrics, decisions, strategy"
  related_skills: "quality-management-system, root-cause-analysis"
  owned_by_agents: "quality-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Corrective & Preventive Action

## Purpose
Control containment, correction, root cause, corrective action, effectiveness verification, and systemic prevention. It operationalizes quality systems, process control, root cause, corrective action, and continuous improvement for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a corrective & preventive action diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify issue.** Produce evidence, confidence, and a decision implication before continuing.
2. **contain.** Produce evidence, confidence, and a decision implication before continuing.
3. **investigate.** Produce evidence, confidence, and a decision implication before continuing.
4. **design action.** Produce evidence, confidence, and a decision implication before continuing.
5. **assess change risk.** Produce evidence, confidence, and a decision implication before continuing.
6. **implement with approval.** Produce evidence, confidence, and a decision implication before continuing.
7. **verify effectiveness.** Produce evidence, confidence, and a decision implication before continuing.
8. **spread learning.** Produce evidence, confidence, and a decision implication before continuing.
9. **Integrate.** Quantify cross-functional effects, dependencies, uncertainty, and opportunity cost in the Business Digital Twin.
10. **Decide.** Recommend the smallest action portfolio that clears hard constraints and maximizes risk-adjusted expected value.
11. **Learn.** Define leading indicators, review date, expected outcome, and conditions to stop, scale, reverse, or escalate.

Read [`references/domain-playbooks/quality.md`](../../../references/domain-playbooks/quality.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `CAPA aging` — baseline, target, actual, trend, confidence, and owner.
- `effectiveness` — baseline, target, actual, trend, confidence, and owner.
- `recurrence` — baseline, target, actual, trend, confidence, and owner.
- `systemic coverage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use corrective & preventive action to improve our outcome without exceeding our cash, risk, or capacity limits."
