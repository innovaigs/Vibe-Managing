...
description: Create an evidence-based system of standards, controls, records, audits, improvement, and accountability appropriate to the business. Use when a founder or agent needs an evidence-backed quality management system decision or operating plan.
metadata:
  domain: quality
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "root-cause-analysis, corrective-preventive-action"
  owned_by_agents: "quality-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Quality Management System

## Purpose
Create an evidence-based system of standards, controls, records, audits, improvement, and accountability appropriate to the business. It operationalizes quality systems, process control, root cause, corrective action, and continuous improvement for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a quality management system diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define quality objectives.** Produce evidence, confidence, and a decision implication before continuing.
2. **map critical processes.** Produce evidence, confidence, and a decision implication before continuing.
3. **set standards and controls.** Produce evidence, confidence, and a decision implication before continuing.
4. **manage documents and training.** Produce evidence, confidence, and a decision implication before continuing.
5. **audit.** Produce evidence, confidence, and a decision implication before continuing.
6. **review performance.** Produce evidence, confidence, and a decision implication before continuing.
7. **improve.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `conformance` — baseline, target, actual, trend, confidence, and owner.
- `customer defects` — baseline, target, actual, trend, confidence, and owner.
- `audit closure` — baseline, target, actual, trend, confidence, and owner.
- `quality cost` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use quality management system to improve our outcome without exceeding our cash, risk, or capacity limits."
