...
description: Find and verify the controllable system causes of recurring failures instead of treating symptoms. Use when a founder or agent needs an evidence-backed root cause analysis decision or operating plan.
metadata:
  domain: quality
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "quality-management-system, corrective-preventive-action"
...
## Purpose
Find and verify the controllable system causes of recurring failures instead of treating symptoms. It operationalizes quality systems, process control, root cause, corrective action, and continuous improvement for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a root cause analysis diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define problem precisely.** Produce evidence, confidence, and a decision implication before continuing.
2. **contain impact.** Produce evidence, confidence, and a decision implication before continuing.
3. **collect timeline and data.** Produce evidence, confidence, and a decision implication before continuing.
4. **map causes.** Produce evidence, confidence, and a decision implication before continuing.
5. **test hypotheses.** Produce evidence, confidence, and a decision implication before continuing.
6. **identify root and escape cause.** Produce evidence, confidence, and a decision implication before continuing.
7. **verify corrective action.** Produce evidence, confidence, and a decision implication before continuing.
...
- `verified root-cause rate` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use root cause analysis to improve our outcome without exceeding our cash, risk, or capacity limits."
