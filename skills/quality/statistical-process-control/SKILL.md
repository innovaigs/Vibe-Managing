...
description: Distinguish common-cause from special-cause variation and control processes without tampering. Use when a founder or agent needs an evidence-backed statistical process control decision or operating plan.
metadata:
  domain: quality
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "quality-management-system, root-cause-analysis, corrective-preventive-action"
  owned_by_agents: "quality-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Statistical Process Control

## Purpose
Distinguish common-cause from special-cause variation and control processes without tampering. It operationalizes quality systems, process control, root cause, corrective action, and continuous improvement for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a statistical process control diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define measure and sampling.** Produce evidence, confidence, and a decision implication before continuing.
2. **establish baseline.** Produce evidence, confidence, and a decision implication before continuing.
3. **select chart.** Produce evidence, confidence, and a decision implication before continuing.
4. **calculate limits.** Produce evidence, confidence, and a decision implication before continuing.
5. **detect signals.** Produce evidence, confidence, and a decision implication before continuing.
6. **investigate special cause.** Produce evidence, confidence, and a decision implication before continuing.
7. **improve capability.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `process capability` — baseline, target, actual, trend, confidence, and owner.
- `out-of-control signals` — baseline, target, actual, trend, confidence, and owner.
- `defect rate` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use statistical process control to improve our outcome without exceeding our cash, risk, or capacity limits."
