...
description: Control requests, drafting, review, approval, signature, obligations, renewal, and termination across contracts. Use when a founder or agent needs an evidence-backed contract lifecycle management decision or operating plan.
metadata:
  domain: legal
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "legal-escalation-router, regulatory-obligation-mapping"
...
## Purpose
Control requests, drafting, review, approval, signature, obligations, renewal, and termination across contracts. It operationalizes obligation mapping, contract lifecycle, records, legal escalation, and defensibility for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a contract lifecycle management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Classify contract.** Produce evidence, confidence, and a decision implication before continuing.
2. **apply playbook.** Produce evidence, confidence, and a decision implication before continuing.
3. **extract terms.** Produce evidence, confidence, and a decision implication before continuing.
4. **route deviations.** Produce evidence, confidence, and a decision implication before continuing.
5. **track obligations.** Produce evidence, confidence, and a decision implication before continuing.
6. **manage renewal and termination windows.** Produce evidence, confidence, and a decision implication before continuing.
...
- `obligation completion` — baseline, target, actual, trend, confidence, and owner.
- `leakage` — baseline, target, actual, trend, confidence, and owner.
- `auto-renewal exposure` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use contract lifecycle management to improve our outcome without exceeding our cash, risk, or capacity limits."
