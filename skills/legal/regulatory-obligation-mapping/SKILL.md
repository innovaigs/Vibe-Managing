...
description: Create a jurisdiction- and activity-specific inventory of obligations, owners, evidence, deadlines, and counsel questions. Use when a founder or agent needs an evidence-backed regulatory obligation mapping decision or operating plan.
metadata:
  domain: legal
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, legal"
  writes: "legal, metrics, decisions, strategy"
  related_skills: "legal-escalation-router, contract-lifecycle-management"
  owned_by_agents: "legal-liaison-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Regulatory Obligation Mapping

## Purpose
Create a jurisdiction- and activity-specific inventory of obligations, owners, evidence, deadlines, and counsel questions. It operationalizes obligation mapping, contract lifecycle, records, legal escalation, and defensibility for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a regulatory obligation mapping diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map entities and activities.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify regulators and licenses.** Produce evidence, confidence, and a decision implication before continuing.
3. **catalog obligations.** Produce evidence, confidence, and a decision implication before continuing.
4. **assign owners.** Produce evidence, confidence, and a decision implication before continuing.
5. **define evidence and calendar.** Produce evidence, confidence, and a decision implication before continuing.
6. **flag legal interpretation.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/legal.md`](../../../references/domain-playbooks/legal.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `obligation coverage` — baseline, target, actual, trend, confidence, and owner.
- `missed deadlines` — baseline, target, actual, trend, confidence, and owner.
- `unresolved legal interpretations` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use regulatory obligation mapping to improve our outcome without exceeding our cash, risk, or capacity limits."
