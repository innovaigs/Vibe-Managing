...
description: Classify records and manage retention, holds, access, disposal, and evidence under approved legal policy. Use when a founder or agent needs an evidence-backed records retention decision or operating plan.
metadata:
  domain: legal
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "legal-escalation-router, regulatory-obligation-mapping, contract-lifecycle-management"
  owned_by_agents: "legal-liaison-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Records Retention

## Purpose
Classify records and manage retention, holds, access, disposal, and evidence under approved legal policy. It operationalizes obligation mapping, contract lifecycle, records, legal escalation, and defensibility for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a records retention diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory record classes.** Produce evidence, confidence, and a decision implication before continuing.
2. **map obligations.** Produce evidence, confidence, and a decision implication before continuing.
3. **assign retention.** Produce evidence, confidence, and a decision implication before continuing.
4. **enforce holds.** Produce evidence, confidence, and a decision implication before continuing.
5. **control access.** Produce evidence, confidence, and a decision implication before continuing.
6. **audit disposal.** Produce evidence, confidence, and a decision implication before continuing.
7. **escalate legal conflicts.** Produce evidence, confidence, and a decision implication before continuing.
...
- `hold compliance` — baseline, target, actual, trend, confidence, and owner.
- `unauthorized retention or disposal` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use records retention to improve our outcome without exceeding our cash, risk, or capacity limits."
