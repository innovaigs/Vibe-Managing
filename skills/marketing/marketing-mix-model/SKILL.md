...
description: Allocate marketing investment across channels using incrementality, saturation, lag, margin, and strategic effects. Use when a founder or agent needs an evidence-backed marketing mix model decision or operating plan.
metadata:
  domain: marketing
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Allocate marketing investment across channels using incrementality, saturation, lag, margin, and strategic effects. It operationalizes market creation, brand, demand, lifecycle communication, and channel economics for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a marketing mix model diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Normalize channel data.** Produce evidence, confidence, and a decision implication before continuing.
2. **separate base demand.** Produce evidence, confidence, and a decision implication before continuing.
3. **estimate incremental response.** Produce evidence, confidence, and a decision implication before continuing.
4. **model lag and saturation.** Produce evidence, confidence, and a decision implication before continuing.
5. **optimize under constraints.** Produce evidence, confidence, and a decision implication before continuing.
6. **validate with experiments.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `incremental ROAS` — baseline, target, actual, trend, confidence, and owner.
- `marginal CAC` — baseline, target, actual, trend, confidence, and owner.
- `contribution after marketing` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use marketing mix model to improve our outcome without exceeding our cash, risk, or capacity limits."
