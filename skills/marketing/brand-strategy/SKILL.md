---
name: brand-strategy
description: Define the distinctive promise, evidence, memory structures, and experience that create preference and pricing power. Use when a founder or agent needs an evidence-backed brand strategy decision or operating plan.
metadata:
  domain: marketing
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, marketing"
  writes: "marketing, metrics, decisions, strategy"
  related_skills: "market-segmentation, customer-value-proposition-builder, causal-decision-analysis"
  owned_by_agents: "marketing-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Brand Strategy

## Purpose
Define the distinctive promise, evidence, memory structures, and experience that create preference and pricing power. It operationalizes market creation, brand, demand, lifecycle communication, and channel economics for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a brand strategy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Research category and audience.** Produce evidence, confidence, and a decision implication before continuing.
2. **define positioning.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify distinctive assets.** Produce evidence, confidence, and a decision implication before continuing.
4. **build proof system.** Produce evidence, confidence, and a decision implication before continuing.
5. **align touchpoints.** Produce evidence, confidence, and a decision implication before continuing.
6. **measure mental and behavioral availability.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/marketing.md`](../../../references/domain-playbooks/marketing.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `branded search` — baseline, target, actual, trend, confidence, and owner.
- `direct demand` — baseline, target, actual, trend, confidence, and owner.
- `preference` — baseline, target, actual, trend, confidence, and owner.
- `price realization` — baseline, target, actual, trend, confidence, and owner.
...
## Related Skills
- `market-segmentation`
- `customer-value-proposition-builder`
...
## Example
**Founder intent:** "Use brand strategy to improve our outcome without exceeding our cash, risk, or capacity limits."
