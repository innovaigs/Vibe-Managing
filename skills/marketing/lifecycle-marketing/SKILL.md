...
description: Coordinate communication across acquisition, onboarding, activation, retention, expansion, and win-back. Use when a founder or agent needs an evidence-backed lifecycle marketing decision or operating plan.
metadata:
  domain: marketing
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Coordinate communication across acquisition, onboarding, activation, retention, expansion, and win-back. It operationalizes market creation, brand, demand, lifecycle communication, and channel economics for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a lifecycle marketing diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map lifecycle states.** Produce evidence, confidence, and a decision implication before continuing.
2. **define state transitions.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify friction and triggers.** Produce evidence, confidence, and a decision implication before continuing.
4. **design messages and offers.** Produce evidence, confidence, and a decision implication before continuing.
5. **set suppression rules.** Produce evidence, confidence, and a decision implication before continuing.
6. **measure incremental lift.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `activation` — baseline, target, actual, trend, confidence, and owner.
- `retention` — baseline, target, actual, trend, confidence, and owner.
- `expansion` — baseline, target, actual, trend, confidence, and owner.
- `incremental lifecycle revenue` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use lifecycle marketing to improve our outcome without exceeding our cash, risk, or capacity limits."
