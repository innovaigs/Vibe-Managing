...
description: Contain, investigate, recover from, communicate, and learn from a suspected security or privacy incident. Use when a founder or agent needs an evidence-backed security incident response decision or operating plan.
metadata:
  domain: security-privacy
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, security_privacy"
  writes: "security_privacy, metrics, decisions, strategy"
  related_skills: "security-posture-assessment, regulatory-obligation-mapping"
  owned_by_agents: "security-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Security Incident Response

## Purpose
Contain, investigate, recover from, communicate, and learn from a suspected security or privacy incident. It operationalizes security posture, identity, privacy, incident response, and cyber resilience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a security incident response diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Triage evidence.** Produce evidence, confidence, and a decision implication before continuing.
2. **classify severity.** Produce evidence, confidence, and a decision implication before continuing.
3. **preserve evidence.** Produce evidence, confidence, and a decision implication before continuing.
4. **contain safely.** Produce evidence, confidence, and a decision implication before continuing.
5. **coordinate specialists.** Produce evidence, confidence, and a decision implication before continuing.
6. **recover and validate.** Produce evidence, confidence, and a decision implication before continuing.
7. **notify per counsel.** Produce evidence, confidence, and a decision implication before continuing.
8. **learn.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/security-privacy.md`](../../../references/domain-playbooks/security-privacy.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `containment time` — baseline, target, actual, trend, confidence, and owner.
- `recovery time` — baseline, target, actual, trend, confidence, and owner.
- `evidence integrity` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use security incident response to improve our outcome without exceeding our cash, risk, or capacity limits."
