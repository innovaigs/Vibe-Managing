...
description: Evaluate proposed data processing for necessity, proportionality, rights, security, retention, sharing, and jurisdictional obligations. Use when a founder or agent needs an evidence-backed privacy impact assessment decision or operating plan.
metadata:
...
## Purpose
Evaluate proposed data processing for necessity, proportionality, rights, security, retention, sharing, and jurisdictional obligations. It operationalizes security posture, identity, privacy, incident response, and cyber resilience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a privacy impact assessment diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Describe purpose and data flow.** Produce evidence, confidence, and a decision implication before continuing.
2. **minimize data.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify people and rights.** Produce evidence, confidence, and a decision implication before continuing.
4. **assess lawful basis with counsel.** Produce evidence, confidence, and a decision implication before continuing.
5. **evaluate risk.** Produce evidence, confidence, and a decision implication before continuing.
6. **design controls.** Produce evidence, confidence, and a decision implication before continuing.
7. **approve or stop.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `high-risk processing coverage` — baseline, target, actual, trend, confidence, and owner.
- `data minimization` — baseline, target, actual, trend, confidence, and owner.
- `unresolved privacy risk` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use privacy impact assessment to improve our outcome without exceeding our cash, risk, or capacity limits."
