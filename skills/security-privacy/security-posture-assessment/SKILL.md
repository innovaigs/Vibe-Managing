...
description: Prioritize cyber risk using assets, threats, vulnerabilities, controls, business impact, and exposure paths. Use when a founder or agent needs an evidence-backed security posture assessment decision or operating plan.
metadata:
  ...
  related_skills: "security-incident-response, regulatory-obligation-mapping"
...
## Purpose
Prioritize cyber risk using assets, threats, vulnerabilities, controls, business impact, and exposure paths. It operationalizes security posture, identity, privacy, incident response, and cyber resilience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a security posture assessment diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory critical assets.** Produce evidence, confidence, and a decision implication before continuing.
2. **map threats and attack paths.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess controls.** Produce evidence, confidence, and a decision implication before continuing.
4. **estimate likelihood and impact.** Produce evidence, confidence, and a decision implication before continuing.
5. **prioritize remediation.** Produce evidence, confidence, and a decision implication before continuing.
6. **set verification.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `critical exposure` — baseline, target, actual, trend, confidence, and owner.
- `control coverage` — baseline, target, actual, trend, confidence, and owner.
- `remediation age` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use security posture assessment to improve our outcome without exceeding our cash, risk, or capacity limits."
