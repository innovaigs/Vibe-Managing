...
description: Ensure each human and machine identity has minimum justified access with timely approval, review, and removal. Use when a founder or agent needs an evidence-backed identity & access governance decision or operating plan.
metadata:
  ...
  related_skills: "security-posture-assessment, security-incident-response, regulatory-obligation-mapping"
...
## Purpose
Ensure each human and machine identity has minimum justified access with timely approval, review, and removal. It operationalizes security posture, identity, privacy, incident response, and cyber resilience for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a identity & access governance diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory identities.** Produce evidence, confidence, and a decision implication before continuing.
2. **map roles and entitlements.** Produce evidence, confidence, and a decision implication before continuing.
3. **identify toxic combinations.** Produce evidence, confidence, and a decision implication before continuing.
4. **apply least privilege.** Produce evidence, confidence, and a decision implication before continuing.
5. **review access.** Produce evidence, confidence, and a decision implication before continuing.
6. **automate joiner-mover-leaver.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `excess privilege` — baseline, target, actual, trend, confidence, and owner.
- `orphaned accounts` — baseline, target, actual, trend, confidence, and owner.
- `review completion` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use identity & access governance to improve our outcome without exceeding our cash, risk, or capacity limits."
