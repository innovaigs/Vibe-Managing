---
name: cross-border-economics
description: Model taxes, duties, freight, currency, payments, returns, service, and working capital to reveal true cross-border contribution. Use when a founder or agent needs an evidence-backed cross-border economics decision or operating plan.
metadata:
  domain: international
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, international"
  writes: "international, metrics, decisions, strategy"
  related_skills: "international-market-entry, jurisdiction-risk"
  owned_by_agents: "international-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Cross-Border Economics

## Purpose
Model taxes, duties, freight, currency, payments, returns, service, and working capital to reveal true cross-border contribution. It operationalizes cross-border entry, localization, economics, operations, and jurisdiction risk for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a cross-border economics diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map transaction flow.** Produce evidence, confidence, and a decision implication before continuing.
2. **calculate landed revenue and cost.** Produce evidence, confidence, and a decision implication before continuing.
3. **model FX and tax scenarios with specialists.** Produce evidence, confidence, and a decision implication before continuing.
4. **include cash timing.** Produce evidence, confidence, and a decision implication before continuing.
5. **set minimum economics.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/international.md`](../../../references/domain-playbooks/international.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `landed margin` — baseline, target, actual, trend, confidence, and owner.
- `cash cycle` — baseline, target, actual, trend, confidence, and owner.
- `FX exposure` — baseline, target, actual, trend, confidence, and owner.
- `return-adjusted contribution` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use cross-border economics to improve our outcome without exceeding our cash, risk, or capacity limits."
