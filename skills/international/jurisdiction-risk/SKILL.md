...
description: Compare country and region exposures across legal, political, currency, labor, data, supply, and operational dimensions. Use when a founder or agent needs an evidence-backed jurisdiction risk decision or operating plan.
metadata:
  ...
  related_skills: "international-market-entry, cross-border-economics"
...
## Purpose
Compare country and region exposures across legal, political, currency, labor, data, supply, and operational dimensions. It operationalizes cross-border entry, localization, economics, operations, and jurisdiction risk for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a jurisdiction risk diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define exposure.** Produce evidence, confidence, and a decision implication before continuing.
2. **collect authoritative evidence.** Produce evidence, confidence, and a decision implication before continuing.
3. **score dimensions.** Produce evidence, confidence, and a decision implication before continuing.
4. **model concentration and scenarios.** Produce evidence, confidence, and a decision implication before continuing.
5. **define limits and mitigations.** Produce evidence, confidence, and a decision implication before continuing.
6. **escalate legal interpretation.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `risk-adjusted market value` — baseline, target, actual, trend, confidence, and owner.
- `concentration` — baseline, target, actual, trend, confidence, and owner.
- `mitigation coverage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use jurisdiction risk to improve our outcome without exceeding our cash, risk, or capacity limits."
