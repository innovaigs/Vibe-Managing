...
description: Adapt product, experience, language, pricing, channels, support, and operations to local customer and regulatory context. Use when a founder or agent needs an evidence-backed localization strategy decision or operating plan.
metadata:
  ...
  related_skills: "international-market-entry, cross-border-economics, jurisdiction-risk"
...
## Purpose
Adapt product, experience, language, pricing, channels, support, and operations to local customer and regulatory context. It operationalizes cross-border entry, localization, economics, operations, and jurisdiction risk for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a localization strategy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Research local jobs and norms.** Produce evidence, confidence, and a decision implication before continuing.
2. **classify adaptation depth.** Produce evidence, confidence, and a decision implication before continuing.
3. **localize value and experience.** Produce evidence, confidence, and a decision implication before continuing.
4. **validate.** Produce evidence, confidence, and a decision implication before continuing.
5. **operationalize governance.** Produce evidence, confidence, and a decision implication before continuing.
6. **monitor fit.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `local conversion` — baseline, target, actual, trend, confidence, and owner.
- `local satisfaction` — baseline, target, actual, trend, confidence, and owner.
- `localization defect rate` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use localization strategy to improve our outcome without exceeding our cash, risk, or capacity limits."
