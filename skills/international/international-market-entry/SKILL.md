...
description: Choose whether, where, when, and how to enter a foreign market using demand, economics, capability, regulation, and reversibility. Use when a founder or agent needs an evidence-backed international market entry decision or operating plan.
metadata:
  ...
  related_skills: "cross-border-economics, jurisdiction-risk"
  owned_by_agents: "international-agent, adaptation-agent, business-analyst-agent"
---

# Skill: International Market Entry

## Purpose
Choose whether, where, when, and how to enter a foreign market using demand, economics, capability, regulation, and reversibility. It operationalizes cross-border entry, localization, economics, operations, and jurisdiction risk for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a international market entry diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Screen markets.** Produce evidence, confidence, and a decision implication before continuing.
2. **validate demand.** Produce evidence, confidence, and a decision implication before continuing.
3. **map legal and tax questions.** Produce evidence, confidence, and a decision implication before continuing.
4. **model landed economics.** Produce evidence, confidence, and a decision implication before continuing.
5. **choose entry mode.** Produce evidence, confidence, and a decision implication before continuing.
6. **pilot reversibly.** Produce evidence, confidence, and a decision implication before continuing.
7. **define exit gates.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `market contribution` — baseline, target, actual, trend, confidence, and owner.
- `payback` — baseline, target, actual, trend, confidence, and owner.
- `compliance readiness` — baseline, target, actual, trend, confidence, and owner.
- `pilot evidence` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use international market entry to improve our outcome without exceeding our cash, risk, or capacity limits."
