---
name: fraud-control-design
description: Prevent and detect theft, manipulation, conflicts, and unauthorized transactions without paralyzing operations. Use when a founder or agent needs an evidence-backed fraud control design decision or operating plan.
metadata:
  domain: risk
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Prevent and detect theft, manipulation, conflicts, and unauthorized transactions without paralyzing operations. It operationalizes enterprise risk, resilience, insurance, fraud prevention, and control effectiveness for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a fraud control design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map fraud scenarios.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify motive/opportunity/rationalization signals.** Produce evidence, confidence, and a decision implication before continuing.
3. **segregate duties.** Produce evidence, confidence, and a decision implication before continuing.
4. **add approvals and monitoring.** Produce evidence, confidence, and a decision implication before continuing.
5. **design investigation escalation.** Produce evidence, confidence, and a decision implication before continuing.
...
- `exception closure` — baseline, target, actual, trend, confidence, and owner.
- `unauthorized activity` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use fraud control design to improve our outcome without exceeding our cash, risk, or capacity limits."
