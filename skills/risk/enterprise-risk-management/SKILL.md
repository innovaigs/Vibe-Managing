...
description: Connect strategic, financial, operational, cyber, legal, people, and external risks to objectives and decisions. Use when a founder or agent needs an evidence-backed enterprise risk management decision or operating plan.
metadata:
  domain: risk
  version: 1.0.0
  autonomy_ceiling: L2
  ...
  related_skills: "risk-diagnostic, business-continuity-plan"
...
## Purpose
Connect strategic, financial, operational, cyber, legal, people, and external risks to objectives and decisions. It operationalizes enterprise risk, resilience, insurance, fraud prevention, and control effectiveness for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a enterprise risk management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define risk appetite.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify objective-linked risks.** Produce evidence, confidence, and a decision implication before continuing.
3. **assess inherent and residual exposure.** Produce evidence, confidence, and a decision implication before continuing.
4. **evaluate controls.** Produce evidence, confidence, and a decision implication before continuing.
5. **assign treatment.** Produce evidence, confidence, and a decision implication before continuing.
6. **monitor indicators.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `residual exposure` — baseline, target, actual, trend, confidence, and owner.
- `appetite breaches` — baseline, target, actual, trend, confidence, and owner.
- `treatment closure` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use enterprise risk management to improve our outcome without exceeding our cash, risk, or capacity limits."
