...
description: Identify insurable exposures, coverage gaps, limits, exclusions, retentions, and transfer decisions for specialist review. Use when a founder or agent needs an evidence-backed insurance coverage analysis decision or operating plan.
metadata:
  domain: risk
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, risk"
  writes: "risk, metrics, decisions, strategy"
  related_skills: "risk-diagnostic, enterprise-risk-management, business-continuity-plan"
  owned_by_agents: "risk-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Insurance Coverage Analysis

## Purpose
Identify insurable exposures, coverage gaps, limits, exclusions, retentions, and transfer decisions for specialist review. It operationalizes enterprise risk, resilience, insurance, fraud prevention, and control effectiveness for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a insurance coverage analysis diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Inventory assets and exposures.** Produce evidence, confidence, and a decision implication before continuing.
2. **map scenarios.** Produce evidence, confidence, and a decision implication before continuing.
3. **compare policies.** Produce evidence, confidence, and a decision implication before continuing.
4. **test limits and exclusions.** Produce evidence, confidence, and a decision implication before continuing.
5. **estimate retained loss.** Produce evidence, confidence, and a decision implication before continuing.
6. **prepare broker questions.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/risk.md`](../../../references/domain-playbooks/risk.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `uninsured exposure` — baseline, target, actual, trend, confidence, and owner.
- `coverage adequacy` — baseline, target, actual, trend, confidence, and owner.
- `claim readiness` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use insurance coverage analysis to improve our outcome without exceeding our cash, risk, or capacity limits."
