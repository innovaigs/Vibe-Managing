---
name: voice-of-customer-system
description: Turn feedback, behavior, support, sales, and outcome data into prioritized company decisions and closed-loop communication. Use when a founder or agent needs an evidence-backed voice of customer system decision or operating plan.
metadata:
  ...
  related_skills: "customer-health-scoring, unit-economics-engine"
  owned_by_agents: "customer-success-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Voice of Customer System

## Purpose
Turn feedback, behavior, support, sales, and outcome data into prioritized company decisions and closed-loop communication. It operationalizes onboarding, value realization, retention, expansion, and customer intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a voice of customer system diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Collect representative signals.** Produce evidence, confidence, and a decision implication before continuing.
2. **classify theme and severity.** Produce evidence, confidence, and a decision implication before continuing.
3. **connect to segments and economics.** Produce evidence, confidence, and a decision implication before continuing.
4. **prioritize.** Produce evidence, confidence, and a decision implication before continuing.
5. **assign action.** Produce evidence, confidence, and a decision implication before continuing.
6. **close loop and measure.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `insight-to-action time` — baseline, target, actual, trend, confidence, and owner.
- `issue recurrence` — baseline, target, actual, trend, confidence, and owner.
- `feedback coverage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use voice of customer system to improve our outcome without exceeding our cash, risk, or capacity limits."
