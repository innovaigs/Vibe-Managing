...
description: Move each customer from signed agreement to first verified value quickly, reliably, and at sustainable cost. Use when a founder or agent needs an evidence-backed customer onboarding system decision or operating plan.
metadata:
  domain: customer-success
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, customer_success"
  writes: "customer_success, metrics, decisions, strategy"
  related_skills: "customer-health-scoring, voice-of-customer-system, unit-economics-engine"
  owned_by_agents: "customer-success-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Customer Onboarding System

## Purpose
Move each customer from signed agreement to first verified value quickly, reliably, and at sustainable cost. It operationalizes onboarding, value realization, retention, expansion, and customer intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a customer onboarding system diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define value milestone.** Produce evidence, confidence, and a decision implication before continuing.
2. **segment complexity.** Produce evidence, confidence, and a decision implication before continuing.
3. **map dependencies.** Produce evidence, confidence, and a decision implication before continuing.
4. **create success plan.** Produce evidence, confidence, and a decision implication before continuing.
5. **manage risks and handoffs.** Produce evidence, confidence, and a decision implication before continuing.
6. **verify value.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/customer-success.md`](../../../references/domain-playbooks/customer-success.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `time to value` — baseline, target, actual, trend, confidence, and owner.
- `onboarding completion` — baseline, target, actual, trend, confidence, and owner.
- `early churn` — baseline, target, actual, trend, confidence, and owner.
- `onboarding cost` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use customer onboarding system to improve our outcome without exceeding our cash, risk, or capacity limits."
