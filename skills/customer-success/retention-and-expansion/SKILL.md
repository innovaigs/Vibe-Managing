...
description: Diagnose and improve renewal, repeat purchase, expansion, advocacy, and lifetime economics. Use when a founder or agent needs an evidence-backed retention & expansion decision or operating plan.
metadata:
...
# Skill: Retention & Expansion

## Purpose
Diagnose and improve renewal, repeat purchase, expansion, advocacy, and lifetime economics. It operationalizes onboarding, value realization, retention, expansion, and customer intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a retention & expansion diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Cohort retention.** Produce evidence, confidence, and a decision implication before continuing.
2. **separate preventable churn.** Produce evidence, confidence, and a decision implication before continuing.
3. **map value realization.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify expansion triggers.** Produce evidence, confidence, and a decision implication before continuing.
5. **prioritize interventions.** Produce evidence, confidence, and a decision implication before continuing.
6. **test incrementality.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `gross retention` — baseline, target, actual, trend, confidence, and owner.
- `net retention` — baseline, target, actual, trend, confidence, and owner.
- `repeat rate` — baseline, target, actual, trend, confidence, and owner.
- `expansion margin` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use retention & expansion to improve our outcome without exceeding our cash, risk, or capacity limits."
