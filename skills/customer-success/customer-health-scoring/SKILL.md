...
description: Combine product, service, relationship, financial, and outcome signals into an actionable customer risk and opportunity model. Use when a founder or agent needs an evidence-backed customer health scoring decision or operating plan.
metadata:
  ...
  related_skills: "voice-of-customer-system, unit-economics-engine"
  owned_by_agents: "customer-success-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Customer Health Scoring

## Purpose
Combine product, service, relationship, financial, and outcome signals into an actionable customer risk and opportunity model. It operationalizes onboarding, value realization, retention, expansion, and customer intelligence for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a customer health scoring diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define outcomes.** Produce evidence, confidence, and a decision implication before continuing.
2. **select predictive signals.** Produce evidence, confidence, and a decision implication before continuing.
3. **normalize by segment.** Produce evidence, confidence, and a decision implication before continuing.
4. **weight and validate.** Produce evidence, confidence, and a decision implication before continuing.
5. **create intervention bands.** Produce evidence, confidence, and a decision implication before continuing.
6. **monitor model drift.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `risk precision` — baseline, target, actual, trend, confidence, and owner.
- `save rate` — baseline, target, actual, trend, confidence, and owner.
- `health coverage` — baseline, target, actual, trend, confidence, and owner.
- `false alarms` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use customer health scoring to improve our outcome without exceeding our cash, risk, or capacity limits."
