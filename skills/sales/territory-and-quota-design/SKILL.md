---
name: territory-and-quota-design
description: Design fair, attainable territories and quotas from market potential, capacity, ramp, and strategy. Use when a founder or agent needs an evidence-backed territory & quota design decision or operating plan.
metadata:
  domain: sales
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Territory & Quota Design

## Purpose
Design fair, attainable territories and quotas from market potential, capacity, ramp, and strategy. It operationalizes revenue conversion, coverage, commercial design, and deal quality for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a territory & quota design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Estimate potential.** Produce evidence, confidence, and a decision implication before continuing.
2. **segment accounts.** Produce evidence, confidence, and a decision implication before continuing.
3. **model rep capacity and ramp.** Produce evidence, confidence, and a decision implication before continuing.
4. **set coverage.** Produce evidence, confidence, and a decision implication before continuing.
5. **assign territories.** Produce evidence, confidence, and a decision implication before continuing.
6. **stress-test fairness and attainability.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `quota attainment distribution` — baseline, target, actual, trend, confidence, and owner.
- `territory potential variance` — baseline, target, actual, trend, confidence, and owner.
- `coverage ratio` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use territory & quota design to improve our outcome without exceeding our cash, risk, or capacity limits."
