...
description: Create incentives that reward profitable, durable revenue without creating harmful selling behavior. Use when a founder or agent needs an evidence-backed sales compensation design decision or operating plan.
metadata:
  domain: sales
  version: 1.0.0
  autonomy_ceiling: L2
...
# Skill: Sales Compensation Design

## Purpose
Create incentives that reward profitable, durable revenue without creating harmful selling behavior. It operationalizes revenue conversion, coverage, commercial design, and deal quality for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a sales compensation design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define desired behavior.** Produce evidence, confidence, and a decision implication before continuing.
2. **select measures.** Produce evidence, confidence, and a decision implication before continuing.
3. **set pay mix and curve.** Produce evidence, confidence, and a decision implication before continuing.
4. **model edge cases.** Produce evidence, confidence, and a decision implication before continuing.
5. **add quality gates and clawbacks.** Produce evidence, confidence, and a decision implication before continuing.
6. **test cost of sales.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `compensation cost of sales` — baseline, target, actual, trend, confidence, and owner.
- `profitable attainment` — baseline, target, actual, trend, confidence, and owner.
- `quality-adjusted bookings` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use sales compensation design to improve our outcome without exceeding our cash, risk, or capacity limits."
