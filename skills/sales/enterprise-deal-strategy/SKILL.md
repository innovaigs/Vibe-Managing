...
description: Coordinate complex, multi-stakeholder deals while protecting margin, delivery feasibility, risk, and relationship value. Use when a founder or agent needs an evidence-backed enterprise deal strategy decision or operating plan.
metadata:
  domain: sales
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, sales"
  writes: "sales, metrics, decisions, strategy"
  related_skills: "pipeline-and-forecast-review, negotiation-preparation, unit-economics-engine"
  owned_by_agents: "sales-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Enterprise Deal Strategy

## Purpose
Coordinate complex, multi-stakeholder deals while protecting margin, delivery feasibility, risk, and relationship value. It operationalizes revenue conversion, coverage, commercial design, and deal quality for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a enterprise deal strategy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map power and process.** Produce evidence, confidence, and a decision implication before continuing.
2. **quantify customer value.** Produce evidence, confidence, and a decision implication before continuing.
3. **build mutual action plan.** Produce evidence, confidence, and a decision implication before continuing.
4. **design commercial boundaries.** Produce evidence, confidence, and a decision implication before continuing.
5. **plan negotiation.** Produce evidence, confidence, and a decision implication before continuing.
6. **validate delivery and legal readiness.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/sales.md`](../../../references/domain-playbooks/sales.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `win probability` — baseline, target, actual, trend, confidence, and owner.
- `deal margin` — baseline, target, actual, trend, confidence, and owner.
- `cycle time` — baseline, target, actual, trend, confidence, and owner.
- `implementation risk` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use enterprise deal strategy to improve our outcome without exceeding our cash, risk, or capacity limits."
