...
description: Model the economics of each customer, order, product, location, project, contract, or capacity unit. Use when a founder or agent needs an evidence-backed unit economics engine decision or operating plan.
metadata:
  domain: finance
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, finance"
  writes: "finance, metrics, decisions, strategy"
  related_skills: "financial-forecast-builder, scenario-and-sensitivity-analysis, outcome-optimization"
  owned_by_agents: "cfo-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Unit Economics Engine

## Purpose
Model the economics of each customer, order, product, location, project, contract, or capacity unit. It operationalizes economic viability, liquidity, capital allocation, treasury, and enterprise value for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a unit economics engine diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Select economic unit.** Produce evidence, confidence, and a decision implication before continuing.
2. **allocate direct and avoidable costs.** Produce evidence, confidence, and a decision implication before continuing.
3. **calculate contribution.** Produce evidence, confidence, and a decision implication before continuing.
4. **include acquisition and servicing cost.** Produce evidence, confidence, and a decision implication before continuing.
5. **segment cohorts.** Produce evidence, confidence, and a decision implication before continuing.
6. **find breakpoints.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/finance.md`](../../../references/domain-playbooks/finance.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `contribution per unit` — baseline, target, actual, trend, confidence, and owner.
- `LTV:CAC` — baseline, target, actual, trend, confidence, and owner.
- `payback` — baseline, target, actual, trend, confidence, and owner.
- `variable margin` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use unit economics engine to improve our outcome without exceeding our cash, risk, or capacity limits."
