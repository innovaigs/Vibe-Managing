...
description: Allocate cash and capacity among operations, debt, reserves, growth, acquisitions, and owner distributions for maximum risk-adjusted value. Use when a founder or agent needs an evidence-backed capital allocation decision or operating plan.
metadata:
  domain: finance
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Allocate cash and capacity among operations, debt, reserves, growth, acquisitions, and owner distributions for maximum risk-adjusted value. It operationalizes economic viability, liquidity, capital allocation, treasury, and enterprise value for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a capital allocation diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Establish liquidity floor.** Produce evidence, confidence, and a decision implication before continuing.
2. **normalize cash generation.** Produce evidence, confidence, and a decision implication before continuing.
3. **compare investments on NPV/IRR/strategic fit.** Produce evidence, confidence, and a decision implication before continuing.
4. **price risk and reversibility.** Produce evidence, confidence, and a decision implication before continuing.
5. **sequence commitments.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `ROIC` — baseline, target, actual, trend, confidence, and owner.
- `NPV` — baseline, target, actual, trend, confidence, and owner.
- `liquidity headroom` — baseline, target, actual, trend, confidence, and owner.
- `allocation regret` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use capital allocation to improve our outcome without exceeding our cash, risk, or capacity limits."
