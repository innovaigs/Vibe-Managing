...
description: Protect liquidity and control cash movement across accounts, entities, currencies, and time horizons. Use when a founder or agent needs an evidence-backed treasury management decision or operating plan.
metadata:
  domain: finance
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Protect liquidity and control cash movement across accounts, entities, currencies, and time horizons. It operationalizes economic viability, liquidity, capital allocation, treasury, and enterprise value for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a treasury management diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map balances and obligations.** Produce evidence, confidence, and a decision implication before continuing.
2. **forecast daily liquidity.** Produce evidence, confidence, and a decision implication before continuing.
3. **define account and counterparty limits.** Produce evidence, confidence, and a decision implication before continuing.
4. **optimize yield without impairing access.** Produce evidence, confidence, and a decision implication before continuing.
5. **enforce dual control.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `liquidity coverage` — baseline, target, actual, trend, confidence, and owner.
- `idle cash` — baseline, target, actual, trend, confidence, and owner.
- `counterparty concentration` — baseline, target, actual, trend, confidence, and owner.
- `unauthorized transactions` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use treasury management to improve our outcome without exceeding our cash, risk, or capacity limits."
