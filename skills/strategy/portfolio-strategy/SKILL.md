...
description: Choose, fund, sequence, pause, or stop the company's portfolio of businesses, products, markets, and initiatives. Use when a founder or agent needs an evidence-backed portfolio strategy decision or operating plan.
metadata:
  domain: strategy
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Choose, fund, sequence, pause, or stop the company's portfolio of businesses, products, markets, and initiatives. It operationalizes direction, portfolio choices, business model, and competitive advantage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a portfolio strategy diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map strategic bets.** Produce evidence, confidence, and a decision implication before continuing.
2. **estimate risk-adjusted value.** Produce evidence, confidence, and a decision implication before continuing.
3. **test concentration and option value.** Produce evidence, confidence, and a decision implication before continuing.
4. **allocate scarce resources.** Produce evidence, confidence, and a decision implication before continuing.
5. **set review and exit triggers.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `portfolio risk-adjusted value` — baseline, target, actual, trend, confidence, and owner.
- `capital concentration` — baseline, target, actual, trend, confidence, and owner.
- `strategic option coverage` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use portfolio strategy to improve our outcome without exceeding our cash, risk, or capacity limits."
