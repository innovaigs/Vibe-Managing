...
description: Design or redesign how value is created, delivered, monetized, and defended. Use when a founder or agent needs an evidence-backed business model design decision or operating plan.
metadata:
  domain: strategy
  version: 1.0.0
  autonomy_ceiling: L2
...
## Purpose
Design or redesign how value is created, delivered, monetized, and defended. It operationalizes direction, portfolio choices, business model, and competitive advantage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a business model design diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Map customer job and value exchange.** Produce evidence, confidence, and a decision implication before continuing.
2. **define revenue and cost mechanics.** Produce evidence, confidence, and a decision implication before continuing.
3. **test unit economics.** Produce evidence, confidence, and a decision implication before continuing.
4. **identify key resources and partners.** Produce evidence, confidence, and a decision implication before continuing.
5. **stress-test defensibility.** Produce evidence, confidence, and a decision implication before continuing.
...
## KPIs
- `contribution margin` — baseline, target, actual, trend, confidence, and owner.
- `recurring revenue share` — baseline, target, actual, trend, confidence, and owner.
- `payback period` — baseline, target, actual, trend, confidence, and owner.
- `model resilience` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use business model design to improve our outcome without exceeding our cash, risk, or capacity limits."
