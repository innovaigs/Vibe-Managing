...
description: Prepare decisions that remain robust across plausible market, technology, regulatory, and competitive futures. Use when a founder or agent needs an evidence-backed strategic scenario planning decision or operating plan.
metadata:
  domain: strategy
  version: 1.0.0
  autonomy_ceiling: L2
  provenance: CLAUDE
  reads: "company, goals, strategy, metrics, decisions, strategy"
  writes: "strategy, metrics, decisions, strategy"
  related_skills: "strategic-planning, initiative-prioritization, outcome-optimization"
  owned_by_agents: "strategy-agent, adaptation-agent, business-analyst-agent"
---

# Skill: Strategic Scenario Planning

## Purpose
Prepare decisions that remain robust across plausible market, technology, regulatory, and competitive futures. It operationalizes direction, portfolio choices, business model, and competitive advantage for companies of different sizes, models, industries, stages, and jurisdictions.

## When to Use
- The founder asks for a strategic scenario planning diagnosis, decision, plan, or review.
...
## Analysis Framework
1. **Define focal uncertainty.** Produce evidence, confidence, and a decision implication before continuing.
2. **identify critical forces.** Produce evidence, confidence, and a decision implication before continuing.
3. **build distinct scenarios.** Produce evidence, confidence, and a decision implication before continuing.
4. **test strategy in each.** Produce evidence, confidence, and a decision implication before continuing.
5. **define signposts and contingent moves.** Produce evidence, confidence, and a decision implication before continuing.
...
Read [`references/domain-playbooks/strategy.md`](../../../references/domain-playbooks/strategy.md) when adapting this method to a specific industry, lifecycle stage, maturity level, or business model.
...
## KPIs
- `scenario coverage` — baseline, target, actual, trend, confidence, and owner.
- `signpost lead time` — baseline, target, actual, trend, confidence, and owner.
- `contingent-plan readiness` — baseline, target, actual, trend, confidence, and owner.
...
## Example
**Founder intent:** "Use strategic scenario planning to improve our outcome without exceeding our cash, risk, or capacity limits."
