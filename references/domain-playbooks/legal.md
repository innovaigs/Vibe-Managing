# Legal Advanced Operating Playbook

Use this reference only when a `legal` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own obligation mapping, contract lifecycle, records, legal escalation, and defensibility. Optimize enterprise outcomes rather than a local metric.
