# Marketing Advanced Operating Playbook

Use this reference only when a `marketing` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own market creation, brand, demand, lifecycle communication, and channel economics. Optimize enterprise outcomes rather than a local metric.
