# Projects & Programs Advanced Operating Playbook

Use this reference only when a `projects-programs` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own initiative delivery, dependencies, benefits, resources, and portfolio governance. Optimize enterprise outcomes rather than a local metric.
