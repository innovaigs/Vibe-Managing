# Finance Advanced Operating Playbook

Use this reference only when a `finance` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own economic viability, liquidity, capital allocation, treasury, and enterprise value. Optimize enterprise outcomes rather than a local metric.
