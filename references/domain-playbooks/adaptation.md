# Business Adaptation Advanced Operating Playbook

Use this reference only when a `adaptation` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own business archetype, industry, stage, geography, maturity, benchmark, and capability routing. Optimize enterprise outcomes rather than a local metric.
...
- Regulatory Intensity Classifier
- Operating Model Fit
