# Data & Analytics Advanced Operating Playbook

Use this reference only when a `data-analytics` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own trusted metrics, data quality, causal reasoning, forecasting, and decision intelligence. Optimize enterprise outcomes rather than a local metric.
