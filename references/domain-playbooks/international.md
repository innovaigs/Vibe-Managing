# International Advanced Operating Playbook

Use this reference only when a `international` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own cross-border entry, localization, economics, operations, and jurisdiction risk. Optimize enterprise outcomes rather than a local metric.
