# Sustainability Advanced Operating Playbook

Use this reference only when a `sustainability` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own material impacts, resource efficiency, resilience, and defensible reporting. Optimize enterprise outcomes rather than a local metric.
