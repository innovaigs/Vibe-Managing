# Customer Success Advanced Operating Playbook

Use this reference only when a `customer-success` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own onboarding, value realization, retention, expansion, and customer intelligence. Optimize enterprise outcomes rather than a local metric.
