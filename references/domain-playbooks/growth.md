# Growth Advanced Operating Playbook

Use this reference only when a `growth` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own repeatable growth systems, experimentation, expansion, and compounding. Optimize enterprise outcomes rather than a local metric.
