# Governance Advanced Operating Playbook

Use this reference only when a `governance` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own decision rights, board effectiveness, policies, accountability, and stakeholder oversight. Optimize enterprise outcomes rather than a local metric.
