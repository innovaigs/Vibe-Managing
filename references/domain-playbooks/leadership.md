# Leadership Advanced Operating Playbook

Use this reference only when a `leadership` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own decision quality, change, succession, executive leverage, and organizational clarity. Optimize enterprise outcomes rather than a local metric.
