# People Advanced Operating Playbook

Use this reference only when a `people` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own workforce architecture, performance, capability, rewards, and employee experience. Optimize enterprise outcomes rather than a local metric.
