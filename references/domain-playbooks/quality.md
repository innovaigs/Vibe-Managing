# Quality Advanced Operating Playbook

Use this reference only when a `quality` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own quality systems, process control, root cause, corrective action, and continuous improvement. Optimize enterprise outcomes rather than a local metric.
