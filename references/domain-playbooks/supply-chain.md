# Supply Chain Advanced Operating Playbook

Use this reference only when a `supply-chain` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own demand, sourcing, suppliers, inventory, logistics, and continuity. Optimize enterprise outcomes rather than a local metric.
