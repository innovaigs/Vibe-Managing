# Product Advanced Operating Playbook

Use this reference only when a `product` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own product discovery, strategy, portfolio, roadmap, economics, and adoption. Optimize enterprise outcomes rather than a local metric.
