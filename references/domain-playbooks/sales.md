# Sales Advanced Operating Playbook

Use this reference only when a `sales` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own revenue conversion, coverage, commercial design, and deal quality. Optimize enterprise outcomes rather than a local metric.
