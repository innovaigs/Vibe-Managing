# Risk Advanced Operating Playbook

Use this reference only when a `risk` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own enterprise risk, resilience, insurance, fraud prevention, and control effectiveness. Optimize enterprise outcomes rather than a local metric.
