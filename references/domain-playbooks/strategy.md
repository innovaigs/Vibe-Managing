# Strategy Advanced Operating Playbook

Use this reference only when a `strategy` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own direction, portfolio choices, business model, and competitive advantage. Optimize enterprise outcomes rather than a local metric.
...
## Default outcome set
- goal attainment
- strategic initiative return
- portfolio risk-adjusted value
