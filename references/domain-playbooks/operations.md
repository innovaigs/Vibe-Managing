# Operations Advanced Operating Playbook

Use this reference only when a `operations` skill needs context-specific adaptation. It is not a generic checklist and does not replace licensed or accountable specialists.

## Mandate
Own capacity, flow, reliability, service delivery, and multi-site execution. Optimize enterprise outcomes rather than a local metric.
